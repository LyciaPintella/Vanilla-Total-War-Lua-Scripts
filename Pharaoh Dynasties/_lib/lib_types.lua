...
TYPE_CAMPAIGN_CONVERSATION = "campaign_conversation";
...
TYPE_MODULAR_DIFFICULTY_MANAGER = "modular_difficulty_manager";
TYPE_ATTACK_LANE_MANAGER = "attack_lane_manager";
TYPE_TOPIC_LEADER = "topic_leader";
TYPE_KEY_STEAL_MANAGER = "key_steal_manager";
...
--- @function is_infotext
--- @desc Returns true if the supplied value is a valid table of infotext, or false otherwise. Infotext records can be @string, @number or @function values.
--- @p value value
--- @r @boolean value is infotext table
--- @r @string error message
function is_infotext(value)
	if not table(value) then
		return false, "value is not a table";
	end;

	for i = 1, #value do
		local current_type = type(value[i]);
		if current_type ~= "string" and current_type ~= "number" and current_type ~= "function" then
			return false, "value at key [" .. i .. "] is [" .. tostring(value[i]) .. "] of type [" .. current_type .. "], which is not a supported infotext value";
		end;
	end;
end;
...
--- @desc Returns true if the supplied value is neither nil, nor false, nor a campaign null script interface, false otherwise.
--- @p value value
--- @r @boolean is not_null
function is_not_null(value)
	return value and not is_null(value)
end
...
--- @function is_character_details
--- @desc Returns true if the supplied value is a campaign character details interface, false otherwise.
--- @p value value
--- @r @boolean is character details
function is_character_details(value)
	return string.sub(tostring(value), 1, 34) == "CHARACTER_DETAILS_SCRIPT_INTERFACE";
end;
...
--- @function is_textoractivepointer
--- @desc Returns true if the supplied value is a text pointer or an active pointer, false otherwise.
--- @p value value
--- @r @boolean is text or active pointer
function is_textoractivepointer(value)
	return is_custom_type(value, TYPE_TEXT_POINTER) or is_custom_type(value, TYPE_ACTIVE_POINTER);
end;
...
--- @function is_keystealmanager
--- @desc Returns true if the supplied value is a key steal manager, false otherwise.
--- @p value value
--- @r @boolean is key steal manager
function is_keystealmanager(value)
	return is_custom_type(value, TYPE_KEY_STEAL_MANAGER);
end;
...
--- @function is_campaignconversation
--- @desc Returns true if the supplied value is a campaign conversation, false otherwise.
--- @p value value
--- @r @boolean is campaign conversation
function is_campaignconversation(value)
	return is_custom_type(value, TYPE_CAMPAIGN_CONVERSATION);
end;
...
--- @function is_infooverlay
--- @desc Returns true if the supplied value is an info overlay, false otherwise.
--- @p value value
--- @r @boolean is info overlay
function is_infooverlay(value)
	return is_custom_type(value, TYPE_INFO_OVERLAY);
end;


--- @function is_modulardifficultymanager
--- @desc Returns true if the supplied value is a modular difficulty manager, false otherwise.
--- @p value value
--- @r @boolean is info overlay
function is_modulardifficultymanager(value)
	return is_custom_type(value, TYPE_MODULAR_DIFFICULTY_MANAGER);
end;
...
--- @function is_infotext
--- @desc Throws a @global:script_error and returns <code>false</code> if the supplied value is not a valid @table of infotext. Infotext entries are usually of type @string but can be @number or @function values. If the supplied value is either of these value types then <code>true</code> is returned.
--- @p value value
--- @r @boolean value is a string/table of strings
add_validation_function(
	validate, 
	...
	is_infotext, 
	function(error_str) 
		return "is not a valid infotext table - " .. error_str;
	end
);
...
--- @desc Throws a @global:script_error and returns <code>false</code> if the supplied value is not a campaign character interface. If the supplied value is a character interface then <code>true</code> is returned.
--- @p value value
--- @r @boolean value is a character details interface
add_validation_function(validate, "is_character_details", is_character_details, "is not a character details interface");
...
--- @function is_textoractivepointer
--- @desc Throws a @global:script_error and returns <code>false</code> if the supplied value is not a text pointer or an active pointer script object. If the supplied value is a text or active pointer then <code>true</code> is returned.
--- @p value value
--- @r @boolean value is a text or active pointer object
add_validation_function(validate, "is_textoractivepointer", is_textoractivepointer, "is not a text pointer or an active pointer object");
...
--- @function is_keystealmanager
--- @desc Throws a @global:script_error and returns <code>false</code> if the supplied value is not a key steal manager script object. If the supplied value is a key steal manager then <code>true</code> is returned.
--- @p value value
--- @r @boolean value is a key steal manager object
add_validation_function(validate, "is_keystealmanager", is_keystealmanager, "is not a key steal manager script object");
...
--- @function is_campaignconversation
--- @desc Throws a @global:script_error and returns <code>false</code> if the supplied value is not a campaign conversation script object. If the supplied value is a campaign conversation then <code>true</code> is returned.
--- @p value value
--- @r @boolean value is a campaign conversation script object
add_validation_function(validate, "is_campaignconversation", is_campaignconversation, "is not a campaign conversation script object");
...
--- @function is_infooverlay
--- @desc Throws a @global:script_error and returns <code>false</code> if the supplied value is not an info overlay script object. If the supplied value is an info overlay object then <code>true</code> is returned.
--- @p value value
--- @r @boolean value is an info overlay script object
add_validation_function(validate, "is_infooverlay", is_infooverlay, "is not an info overlay script object");


--- @function is_modulardifficultymanager
--- @desc Throws a @global:script_error and returns <code>false</code> if the supplied value is not a modular difficulty manager script object. If the supplied value is a modular difficulty object then <code>true</code> is returned.
--- @p value value
--- @r @boolean value is an attack lane manager script object
add_validation_function(validate, "is_modulardifficultymanager", is_modulardifficultymanager, "is not a modular difficulty manager script object");
