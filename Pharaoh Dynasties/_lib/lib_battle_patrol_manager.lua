...
-- set patrol_manager object to be of custom type TYPE_PATROL_MANAGER, with a custom tostring() response
...
function patrol_manager:new(
	...
	-- set 'pm' to derive from self ('patrol_manager')
...
-- set waypoint object to be of custom type TYPE_WAYPOINT
...
function waypoint:new(new_pos, new_speed, new_wait_time, new_orient, new_width)		
	...
	-- set 'w' to derive from self ('waypoint')
