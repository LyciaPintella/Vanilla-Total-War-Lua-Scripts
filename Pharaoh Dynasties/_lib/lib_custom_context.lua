...
-- set custom_context to be of custom type TYPE_CUSTOM_CONTEXT
...
function custom_context:new()
	...
	-- set 'cc' to derive from self ('custom_context')
...
--- @desc <li>component: will be accessible to the receiving script using <code>&lt;context&gt;.component</code>.</li>
...
function custom_context:add_data(obj)
	...
	elseif is_component(obj) then
		self.component = obj;			-- accessible via context.component
