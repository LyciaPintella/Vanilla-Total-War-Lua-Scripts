...
cam_start_x = 375.41400146484;
cam_start_y = 602.82897949219;
cam_start_d = 14.003234863281;
cam_start_b = 0;
	...
	function()
		...
		if not random_start_pos_enabled then 
			...
			core:progress_on_loading_screen_dismissed(
				function()
					cm:position_camera_at_primary_military_force("phar_main_seti")
				end
			);
		end
	end
...
function play_cutscene_intro()
	...
	advice_to_play[1] = "phar_cam_faction_intro_merneptah_set_01" --#1#
	advice_to_play[2] = "phar_cam_faction_intro_merneptah_set_02" --#21#
	advice_to_play[3] = "phar_cam_faction_intro_merneptah_set_03" --#37#
	advice_to_play[4] = "phar_cam_faction_intro_merneptah_set_04" --#51.5#
	advice_to_play[5] = "phar_cam_faction_intro_merneptah_set_05" --#62#
	advice_to_play[6] = "phar_cam_faction_intro_merneptah_set_06" --#78.5#

	local cutscene_intro = campaign_cutscene:new(
		"intro_cutscene",									-- string name for this cutscene
		101,												-- length of cutscene in seconds
		function()
	...
	cutscene_intro:action(
		function()
			...
			cutscene_intro:cindy_playback(string.format("script/campaign/phar_combi/factions/phar_camp_flybys/scenes/phar_camp_flyby_set_r01_s%s.CindyScene", id), 0, 2);
		end,
		0
	)
	...
	cutscene_intro:action(
		function()
			cm:characters_forced_invisible({seti_forename_id}, false);
