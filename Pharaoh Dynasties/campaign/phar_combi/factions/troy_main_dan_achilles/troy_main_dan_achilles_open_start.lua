...
cam_start_x = 132.7911529541;
cam_start_y = 1104.3657226562;
cam_start_d = 16.319982528687;
cam_start_b = 0;
cam_start_h = 10.345703125;
...
--[[
			...
			core:progress_on_loading_screen_dismissed(
				function()
					cm:position_camera_at_primary_military_force("troy_main_dan_achilles")
				end
			);
		end
	end
