...
cam_start_x = 771.65197753906;
cam_start_y = 963.80493164062;
cam_start_d = 16.132524490356;
cam_start_b = 0;
cam_start_h = 10.085730552673;
...
--[[
			...
			core:progress_on_loading_screen_dismissed(
				function()
					cm:position_camera_at_primary_military_force("phar_main_ugarit")
				end
			);
		end
	end
