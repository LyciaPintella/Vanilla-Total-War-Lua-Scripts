	...
	function()
		...
		if not random_start_pos_enabled then 
			...
			core:progress_on_loading_screen_dismissed(
				function()
					cm:position_camera_at_primary_military_force("phar_map_ninurta")
				end
			);
		end
	end
...
function play_cutscene_intro()
	...
	advice_to_play[1] = {
		text = "phar_cam_faction_intro_merneptah_nin_01",
		time = 1
	}
	advice_to_play[2] = {	
		text = "phar_cam_faction_intro_merneptah_nin_02",
		time = 16
	}
	advice_to_play[3] = {
		text = "phar_cam_faction_intro_merneptah_nin_03",
		time = 29.5
	}
	advice_to_play[4] = {
		text = "phar_cam_faction_intro_merneptah_nin_04",
		time = 43.5
	}
	advice_to_play[5] = {
		text = "phar_cam_faction_intro_merneptah_nin_05",
		time = 54.5
	}
	advice_to_play[6] = {
		text = "phar_cam_faction_intro_merneptah_nin_06",
		time = 68.5
	}
	advice_to_play[7] = {
		text = "phar_cam_faction_intro_merneptah_nin_07",
		time = 81.2
	}

	local cutscene_intro = campaign_cutscene:new(
		"intro_cutscene",									-- string name for this cutscene
		100.5,												-- length of cutscene in seconds
		function() 
	...
	cutscene_intro:action(
		function()
			...
			cutscene_intro:cindy_playback("script/campaign/phar_combi/factions/phar_camp_flybys/scenes/phar_camp_flyby_nin_r01_s01.CindyScene", 0, 2);
		end,
		0
	)
	...
	cutscene_intro:action(
		function()
			cm:show_advice(advice_to_play[7].text);
		end,
		advice_to_play[7].time
	);
