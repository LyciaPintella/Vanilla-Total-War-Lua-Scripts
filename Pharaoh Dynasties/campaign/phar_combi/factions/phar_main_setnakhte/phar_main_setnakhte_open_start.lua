...
cam_start_x = 355.23526000977;
cam_start_y = 731.08898925781;
cam_start_d = 14.96817111969;
cam_start_b = 0.18532864749432;
cam_start_h = 14.803751945496;
...
--[[
			...
			core:progress_on_loading_screen_dismissed(
				function()
					cm:position_camera_at_primary_military_force("phar_main_setnakhte")
				end
			);
		end
	end
