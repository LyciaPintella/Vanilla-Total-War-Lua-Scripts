...
cam_start_x = 717.26232910156;
cam_start_y = 858.95001220703;
cam_start_d = 15.569625854492;
cam_start_b = 0;
cam_start_h = 12.559096336365;
...
--[[
			...
			core:progress_on_loading_screen_dismissed(
				function()
					cm:position_camera_at_primary_military_force("phar_main_byblos")
				end
			);
		end
	end
