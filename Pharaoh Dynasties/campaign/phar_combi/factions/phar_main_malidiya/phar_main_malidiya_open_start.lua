...
cam_start_x = 817.62408447266;
cam_start_y = 1117.3991699219;
cam_start_d = 15.082586288452;
cam_start_b = 0;
cam_start_h = 10.137903213501;
...
--[[
			...
			core:progress_on_loading_screen_dismissed(
				function()
					cm:position_camera_at_primary_military_force("phar_main_malidiya")
				end
			);
		end
	end
