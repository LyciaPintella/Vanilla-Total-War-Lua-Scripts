...
cam_start_x = 372.48165893555;
cam_start_y = 574.86047363281;
cam_start_d = 15.943367958069;
cam_start_b = 0;
cam_start_h = 11.743180274963;
...
--[[
			...
			core:progress_on_loading_screen_dismissed(
				function()
					cm:position_camera_at_primary_military_force("phar_main_bahariya")
				end
			);
		end
	end
