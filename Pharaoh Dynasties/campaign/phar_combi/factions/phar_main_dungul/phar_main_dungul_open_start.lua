...
cam_start_x = 449.52526855469;
cam_start_y = 346.73724365234;
cam_start_d = 16.336877822876;
cam_start_b = 0;
cam_start_h = 9.459753036499;
...
--[[
			...
			core:progress_on_loading_screen_dismissed(
				function()
					cm:position_camera_at_primary_military_force("phar_main_dungul")
				end
			);
		end
	end
