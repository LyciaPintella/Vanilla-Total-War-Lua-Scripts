...
cam_start_x = 438.74737548828;
cam_start_y = 1059.3265380859;
cam_start_d = 14.254091262817;
cam_start_b = 0;
cam_start_h = 12.036436080933;
...
--[[
			...
			core:progress_on_loading_screen_dismissed(
				function()
					cm:position_camera_at_primary_military_force("phar_map_sangarian_phrygians")
				end
			);
		end
	end
