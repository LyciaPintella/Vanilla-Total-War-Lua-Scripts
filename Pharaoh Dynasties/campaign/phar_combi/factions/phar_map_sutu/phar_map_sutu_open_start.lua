...
cam_start_x = 937.63195800781;
cam_start_y = 866.39331054688;
cam_start_d = 15.476755142212;
cam_start_b = 0;
cam_start_h = 11.155744552612;
...
--[[
			...
			core:progress_on_loading_screen_dismissed(
				function()
					cm:position_camera_at_primary_military_force("phar_map_sutu")
				end
			);
		end
	end
