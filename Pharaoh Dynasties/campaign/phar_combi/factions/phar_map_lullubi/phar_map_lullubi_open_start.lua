...
cam_start_x = 1131.8182373047;
cam_start_y = 1023.7731933594;
cam_start_d = 11.836338043213;
cam_start_b = 0;
cam_start_h = 13.466100692749;
...
--[[
			...
			core:progress_on_loading_screen_dismissed(
				function()
					cm:position_camera_at_primary_military_force("phar_map_lullubi")
				end
			);
		end
	end
