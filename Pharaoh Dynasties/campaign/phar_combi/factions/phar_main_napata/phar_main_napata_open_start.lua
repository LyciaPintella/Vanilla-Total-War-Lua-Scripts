...
cam_start_x = 584.69793701172;
cam_start_y = 210.12869262695;
cam_start_d = 16.199789047241;
cam_start_b = 0;
cam_start_h = 11.464352607727;
...
--[[
			...
			core:progress_on_loading_screen_dismissed(
				function()
					cm:position_camera_at_primary_military_force("phar_main_napata")
				end
			);
		end
	end
