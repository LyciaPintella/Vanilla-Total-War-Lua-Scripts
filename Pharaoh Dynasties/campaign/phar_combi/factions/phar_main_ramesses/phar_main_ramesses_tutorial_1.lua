...
function t1_ui_overrides()
	...
	-- disabling the feature removes supply points from unit info, province info and such 
	cm:faction_override_campaign_feature(tut.player_faction_key, "supply_points", false)
	
	-- due to order of execution the bar is visible but will never be updated so manual hide here is the easiest solution
	...
	cm:force_diplomacy("faction:" .. tut.merneptah_faction_key, "faction:" .. tut.per_amun_faction_key, "vassal", false, false, true)

	cm:disallow_army_occupation_decision(
		tut.player_faction_leader_mf_cqi,
...
--	uim:override("hide_resource_troy_gold"):lock()
	...
	if not cm:get_saved_value("unlock_local_deities") then
		...
		uim:override("faction_button"):lock()
	end;
	...
	if not cm:get_saved_value("court_unlocked") then 
		...
		uim:override("hide_ruling_family_dynasty"):lock()
	end
...
function t1_tutorial_intro()
	...
	cm:force_add_and_equip_ancillary(cm:char_lookup_str(tut.player_faction_leader_cqi), "phar_main_rare_equipment_khopesh_5", true)
	...
	cm:set_camera_position(700.263794, 643.982605, 7.657795, -0.622144, 4.0)
	cm:teleport_to(cm:char_lookup_str_fm(tut.player_faction_leader_fm_cqi), 905, 832)
...
camera_sequence_offset[2] = 22.35
...
function t1_play_cutscene_intro()
	local cutscene_intro = campaign_cutscene:new(
		...
		function()
			cm:steal_user_input(true)
			cm:set_camera_position(500.45871, 651.897766, 8.6384725,  0.612871, 4)
	...
	cutscene_intro:set_skip_camera(500.45871, 651.897766, 8.6384725,  0.612871, 4)
	...
	cutscene_intro:action(
		function()
			...
			cm:fade_scene(1, 7)
			cutscene_intro:cindy_playback("script/campaign/phar_combi/factions/phar_camp_tutorial/scenes/phar_camp_tutorial_sq01_sh01.CindyScene", 0, 2);
		end,
	...
	cutscene_intro:action(
		function()
			cutscene_intro:cindy_playback("script/campaign/phar_combi/factions/phar_camp_tutorial/scenes/phar_camp_tutorial_sq01_sh02.CindyScene", 0, 2);
		end,
	...
	cutscene_intro:action(
		function()
			cutscene_intro:cindy_playback("script/campaign/phar_combi/factions/phar_camp_tutorial/scenes/phar_camp_tutorial_sq01_sh03.CindyScene", 0, 2);
		end,
	...
	cutscene_intro:action(
		function()
			...
			cutscene_intro:cindy_playback("script/campaign/phar_combi/factions/phar_camp_tutorial/scenes/phar_camp_tutorial_sq01_sh04.CindyScene", 0, 2);
		end,
	...
	cutscene_intro:action(
		function()
			...
			cutscene_intro:cindy_playback("script/campaign/phar_combi/factions/phar_camp_tutorial/scenes/phar_camp_tutorial_sq01_sh05.CindyScene", 0, 2);
		end,
...
function t1_post_initial_intro_cutscene_dialog()
	...
	local cutscene_intro = campaign_cutscene:new(
		...
		function()
			...
			if sequence_skipped then
				cm:set_camera_position(593.280396, 660.18573, 9.58838, -0.183972, 5.170344)
	...
	cutscene_intro:set_skip_camera(593.280396, 660.18573, 9.58838, -0.183972, 5.170344)
	cutscene_intro:set_should_play_sound_on_finish(false)
	cutscene_intro:set_should_play_sound_on_cindyscene_start(false)
	...
	cutscene_intro:action(
		function()
			...
			cm:set_camera_position(632.747375, 569.975403, 9.380694, 0.6788268, 5.05)
			cm:show_advice(
	...
	cutscene_intro:action(
		function()
			cm:callback(
				function()
					cm:set_camera_position(587.195557, 589.753906, 6.50, -1.1, 3.7)
				end,
				3.5
			);
			cm:show_advice(
	...
	cutscene_intro:action(
		function()
			...
			cm:set_camera_position(603.542969, 643.982605, 7.657795, -0.622144, 4.0) --595.74469 9.695574 649.964905 594.316406 0.0 657.650879
			cm:callback(
				function()
					cm:scroll_camera_from_current(true, 5.5, {593.280396, 660.18573, 9.58838, -0.183972, 5.170344})
				end,
				0.3
			)
...
function t1_arrive_at_nebgehes_first_time()
	...
	cm:scroll_camera_from_current(true, tut.SCROLL_CAMERA_DURATION_S, {599.840637, 674.03833, 16.300802, -1.215001, 11.062487})
	cm:dismiss_advice()
	cm:show_advice(
