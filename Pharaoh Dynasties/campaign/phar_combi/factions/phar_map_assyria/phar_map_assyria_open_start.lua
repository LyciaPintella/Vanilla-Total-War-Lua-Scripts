...
cam_start_x = 1050.197265625;
cam_start_y = 932.88598632812;
cam_start_d = 15.804832458496;
cam_start_b = 0;
cam_start_h = 12.127856254578;
...
--[[
			...
			core:progress_on_loading_screen_dismissed(
				function()
					cm:position_camera_at_primary_military_force("phar_map_assyria")
				end
			);
		end
	end
