...
cam_start_x = 784.67767333984;
cam_start_y = 859.39593505859;
cam_start_d = 5.4329771995544;
cam_start_b = 0;
cam_start_h = 30.530038833618;
...
--[[
			...
			core:progress_on_loading_screen_dismissed(
				function()
					cm:position_camera_at_primary_military_force("phar_main_damascus")
				end
			);
		end
	end
