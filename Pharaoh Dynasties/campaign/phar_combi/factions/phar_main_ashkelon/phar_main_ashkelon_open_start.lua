...
cam_start_x = 669.34985351562;
cam_start_y = 751.89227294922;
cam_start_d = 15.358716011047;
cam_start_b = 0;
cam_start_h = 8.1844501495361;
...
--[[
			...
			core:progress_on_loading_screen_dismissed(
				function()
					cm:position_camera_at_primary_military_force("phar_main_ashkelon")
				end
			);
		end
	end
