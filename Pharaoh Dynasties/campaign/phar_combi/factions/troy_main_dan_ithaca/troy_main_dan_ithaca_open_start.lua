...
cam_start_x = 37.293483734131;
cam_start_y = 1060.2388916016;
cam_start_d = 8.71413230896;
cam_start_b = -1.6291600465775;
cam_start_h = 25.558753967285;
...
--[[
			...
			core:progress_on_loading_screen_dismissed(
				function()
					cm:position_camera_at_primary_military_force("troy_main_dan_ithaca")
				end
			);
		end
	end
