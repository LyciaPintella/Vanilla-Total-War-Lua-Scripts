...
cam_start_x = 835.88757324219;
cam_start_y = 1008.8967285156;
cam_start_d = 13.848337173462;
cam_start_b = 0;
cam_start_h = 14.553997993469;
...
--[[
			...
			core:progress_on_loading_screen_dismissed(
				function()
					cm:position_camera_at_primary_military_force("phar_main_carchemish")
				end
			);
		end
	end
