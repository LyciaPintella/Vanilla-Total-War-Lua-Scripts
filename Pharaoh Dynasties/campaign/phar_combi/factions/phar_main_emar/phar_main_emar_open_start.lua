...
cam_start_x = 856.37390136719;
cam_start_y = 928.50988769531;
cam_start_d = 15.041446685791;
cam_start_b = 0;
cam_start_h = 13.602482795715;
...
--[[
			...
			core:progress_on_loading_screen_dismissed(
				function()
					cm:position_camera_at_primary_military_force("phar_main_emar")
				end
			);
		end
	end
