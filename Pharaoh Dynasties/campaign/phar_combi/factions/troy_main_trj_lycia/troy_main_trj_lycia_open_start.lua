...
cam_start_x = 435.32208251953;
cam_start_y = 974.03424072266;
cam_start_d = 14.346893310547;
cam_start_b = 0.40165883302689;
cam_start_h = 17.558746337891;
...
--[[
			...
			core:progress_on_loading_screen_dismissed(
				function()
					cm:position_camera_at_primary_military_force("troy_main_trj_lycia")
				end
			);
		end
	end
