...
cam_start_x = 129.52279663086;
cam_start_y = 1071.0490722656;
cam_start_d = 15.855166435242;
cam_start_b = 0;
cam_start_h = 12.952376365662;
...
--[[
			...
			core:progress_on_loading_screen_dismissed(
				function()
					cm:position_camera_at_primary_military_force("troy_main_dan_boeotians")
				end
			);
		end
	end
