...
cam_start_x = 712.03546142578;
cam_start_y = 1215.8350830078;
cam_start_d = 15.476739883423;
cam_start_b = 0;
cam_start_h = 13.234024047852;
...
--[[
			...
			core:progress_on_loading_screen_dismissed(
				function()
					cm:position_camera_at_primary_military_force("troy_amazons_trj_hippolyta")
				end
			);
		end
	end
