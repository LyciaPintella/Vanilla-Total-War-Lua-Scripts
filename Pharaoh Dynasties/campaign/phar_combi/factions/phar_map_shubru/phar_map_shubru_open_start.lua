...
cam_start_x = 945.70758056641;
cam_start_y = 1119.0808105469;
cam_start_d = 13.687476158142;
cam_start_b = 0;
cam_start_h = 10.682240486145;
...
--[[
			...
			core:progress_on_loading_screen_dismissed(
				function()
					cm:position_camera_at_primary_military_force("phar_map_shubru")
				end
			);
		end
	end
