out("Loading troy_ajax_champion_challenge_config.lua -> troy_historical")
...
--[[
  ...
  ["troy_adi_dan_achilles_champion"] = {
		...
		reward_main_unit_record = "troy_adi_champion_aeacides",
...
--]]
	...
	["troy_adi_dan_dionysias_champion"] = {
		...
		"troy_main_hero_campaign_post_battle", "troy_main_hero_ability_ignore_pain", 
		"troy_main_hero_ability_ignore_pain_spec_duration", "troy_hist_hero_bodyguard_armour_spec",
		"troy_main_hero_unit_melee_defence", "troy_main_hero_unit_melee_defence_spec_sword",
		"troy_hist_hero_bodyguard_damage_lesser_add_spec", "troy_hist_hero_bodyguard_weapon_strength_land_spec",
		"troy_hist_hero_bodyguard_ach_defender_veteran_armoured_spearmen"},
		bodyguard_unit = "troy_hist_hero_ach_defender_veteran_bodyguard_dendra_spearmen", -- used only in UI
	},
	--3
	["troy_adi_dan_noagria_champion"] = {
		...
		"troy_main_hero_unit_ammunition", "troy_hist_hero_bodyguard_melee_attack_vs_swordsmen_spec", 
		"troy_main_hero_campaign_post_battle",
		"troy_main_hero_ability_bulwark", "troy_main_hero_ability_bulwark_spec_armour", 
		"troy_hist_hero_bodyguard_ach_defender_veteran_shielded_spearmen_bonus_defence"},
		--"troy_main_hero_self_leadership", "troy_main_hero_self_leadership_spec_cause_terror"
		bodyguard_unit = "troy_hist_hero_ach_defender_veteran_bodyguard_shielded_spearmen_bonus_defence", -- used only in UI
	},
	--4
	["troy_adi_dan_knossos_champion"] = {
		...
		"troy_main_hero_campaign_wound_recovery_enemy_agent_resistance", "troy_main_hero_campaign_wound_recovery_enemy_agent_resistance_spec_line_of_sight_enemy_agent_resistance",
		"troy_main_hero_unit_missile_damage", "troy_main_hero_unit_missile_damage_spec_ranged_experience_per_turn",
		"troy_main_hero_ability_rapid_fire", "troy_main_hero_ability_rapid_fire_spec_damage", 
		"troy_main_hero_campaign_ambush_success_defence", 
		"troy_main_hero_unit_range", "troy_main_hero_unit_range_spec_archers", 
		"troy_hist_hero_bodyguard_ranged_armour_piercing_mult_2", "troy_main_hero_unit_speed", 
		"troy_hist_hero_bodyguard_ach_archer_trickster_heavy_achaean_bowmen"},
		bodyguard_unit = "troy_hist_hero_ach_archer_trickster_bodyguard_heavy_achaean_bowmen", -- used only in UI
	},
--[[	
	--5
	["troy_adi_dan_pylos_champion_2"] = {
		...
		reward_main_unit_record = "troy_adi_champion_stratichus", --"troy_adi_champion_aphareus",
...
--]]
	...
	["troy_adi_dan_esperia_champion"] = {
		...
		"troy_main_hero_unit_vigour_loss_reduction", "troy_main_hero_unit_vigour_loss_reduction_spec_recovery",
		"troy_main_hero_campaign_casualties_post_battle", "troy_hist_hero_bodyguard_defence_spec", 
		"troy_hist_hero_bodyguard_ach_fighter_champion_axemen"},
		bodyguard_unit = "troy_hist_hero_ach_fighter_champion_bodyguard_armoured_axemen", -- used only in UI
	},
	--7
	["troy_adi_trj_edonia_champion"] = {
		...
		spawn_level = 16,
		spawn_skills = {"troy_main_hero_ability_frenzy", "troy_main_hero_ability_frenzy_spec_vigour_loss_reduction", 
		"troy_main_hero_campaign_recruitment_cost",
		"troy_main_hero_unit_vigour_loss_reduction", "troy_main_hero_unit_vigour_loss_reduction_spec_recovery",
		"troy_hist_hero_bodyguard_charge_lesser_spec", 
		"troy_main_hero_ability_terrify", "troy_main_hero_ability_terrify_spec_melee_defence_reduction",
		"troy_hist_hero_bodyguard_damage_lesser_add_spec", "troy_hist_hero_bodyguard_weapon_strength_land_spec",
		"troy_hist_hero_trj_dardania_fighter_vanquisher_bodyguard_heavy_anatolian_swords"},
		bodyguard_unit = "troy_hist_hero_trj_dardania_fighter_vanquisher_bodyguard_heavy_anatolian_swords", -- used only in UI
	},
--[[	
	--8
	["troy_adi_trj_cicones_champion"] = {
		...
		reward_main_unit_record = "troy_adi_champion_boreas",
...
--]]
	...
	["troy_adi_dan_ithaca_champion"] = {
		...
		"troy_main_hero_unit_range", "troy_main_hero_unit_range_spec_archers", 
		"troy_hist_hero_bodyguard_ammunition_range_spec", 
		"troy_hist_hero_bodyguard_ach_archer_skirmisher_heavy_achaean_bowmen"},
		bodyguard_unit = "troy_hist_hero_ach_archer_skirmisher_bodyguard_heavy_achaean_bowmen", -- used only in UI
	},
	--10
	["troy_adi_dan_dionysias_champion_2"] = {
		...
		spawn_level = 12,
	  	spawn_skills = {"troy_main_hero_ability_adrenaline_rush","troy_main_hero_ability_adrenaline_rush_spec_speed", 
		  "troy_hist_hero_bodyguard_missile_damage_mult_spec", 
		  "troy_main_hero_unit_vigour_loss_reduction", "troy_main_hero_unit_vigour_loss_reduction_spec_recovery", 
		  "troy_main_hero_campaign_post_battle", 
		  "troy_main_hero_unit_charge", "troy_main_hero_unit_charge_spec_melee",
		  "troy_main_hero_ability_apollos_rain", "troy_main_hero_ability_apollos_rain_spec_range", 
		  "troy_main_hero_unit_melee_attack", 
		  "troy_hist_hero_bodyguard_ach_archer_skirmisher_renowned_bowmen"},
		  -- "troy_main_hero_unit_melee_attack_spec_sword"
		bodyguard_unit = "troy_hist_hero_ach_archer_skirmisher_bodyguard_veteran_bowmen", -- used only in UI
	},
--[[
	--11
	["troy_adi_trj_apsynthioi_champion"] = {
		...
		reward_main_unit_record = "troy_adi_champion_archelochos",
...
--]]
	...
	["troy_adi_dan_sparta_champion"] = {
		...
		"troy_main_hero_campaign_income_raiding_attrition", "",
		"troy_hist_hero_bodyguard_morale_greater_spec", 
		"troy_main_hero_ability_cover", "troy_main_hero_ability_cover_spec_radius", 
		"troy_hist_hero_bodyguard_armour_spec", "troy_hist_hero_bodyguard_defence_spec_2", 
		"troy_main_hero_unit_melee_defence", "troy_main_hero_unit_melee_defence_spec_sword",
		"troy_hist_hero_bodyguard_ach_fighter_champion_laconian_swordsmen"},
		bodyguard_unit = "troy_hist_hero_ach_fighter_champion_bodyguard_laconian_swordsmen", -- used only in UI
	},
	--13
	["troy_adi_dan_pylos_champion"] = {
		...
		spawn_level = 5,
		spawn_skills = {"troy_main_hero_ability_focused_strikes", "troy_main_hero_ability_focused_strikes_spec_less_reduction",
		"troy_hist_hero_bodyguard_ach_fighter_champion_aeginian_runners","troy_hist_hero_bodyguard_melee_attack_vs_spearmen_spec"},
		...
		bodyguard_unit = "troy_hist_hero_ach_achilles_fighter_champion_bodyguard_aeginian_runners", -- used only in UI
	},
	--14
	["troy_adi_dan_knossos_champion_2"] = {
		...
		"troy_main_hero_unit_vigour_loss_reduction", "troy_main_hero_unit_vigour_loss_reduction_spec_recovery",
		"troy_main_hero_campaign_wound_recovery_enemy_agent_resistance", 
		"troy_main_hero_unit_range", "troy_main_hero_unit_range_spec_javelins",
		"troy_hist_hero_bodyguard_fatigue_reduction_spec",
		"troy_main_hero_ability_bulwark", "troy_main_hero_ability_bulwark_spec_armour",
		"troy_main_hero_campaign_replenishment", "troy_main_hero_campaign_replenishment_spec_enemy",
		"troy_hist_hero_bodyguard_damage_lesser_add_spec", "troy_hist_hero_bodyguard_weapon_strength_land_spec",
		"troy_hist_hero_bodyguard_ach_defender_companion_armoured_spearmen"},
		bodyguard_unit = "troy_hist_hero_ach_defender_companion_bodyguard_dendra_spearmen", -- used only in UI
	},
	--15
	["troy_adi_trj_thyni_champion"] = {
		...
		"troy_main_hero_ability_rapid_fire", "troy_main_hero_ability_rapid_fire_spec_damage",
		"troy_main_hero_unit_range", "troy_main_hero_unit_range_spec_archers",
		"troy_main_hero_campaign_ambush_success_defence", "troy_main_hero_campaign_ambush_success_defence_spec_morale_hapiness",
		"troy_hist_hero_bodyguard_battle_speed_mult_greater_spec", 
		"troy_main_hero_unit_speed", "troy_main_hero_unit_speed_spec_land",
		"troy_main_hero_ability_inspired_shots", "troy_main_hero_ability_inspired_shots_spec_damage",
		"troy_hist_hero_trj_paris_archer_skirmisher_bodyguard_trojan_noble_chariots"},
		bodyguard_unit = "troy_hist_hero_trj_paris_archer_skirmisher_bodyguard_trojan_noble_chariots", -- used only in UI
	},
--[[	
	--16
	["troy_adi_dan_phyllis_champion"] = {
		...
		reward_main_unit_record = "troy_adi_champion_phorcys",
...
--]]
	...
	["troy_adi_trj_paeonians_champion"] = {
		...
		spawn_skills = {"troy_main_hero_ability_adrenaline_rush", "troy_main_hero_ability_adrenaline_rush_spec_speed",
		"troy_main_hero_unit_ammunition", "troy_main_hero_unit_ammunition_spec_armour_piercing_missile_resistance_melee",
		"troy_main_hero_campaign_agent_recruitment_rank",
		"troy_main_hero_ability_ignore_pain", "troy_main_hero_ability_ignore_pain_spec_duration",
		"troy_main_hero_unit_melee_defence", 
		"troy_main_hero_campaign_income_raiding_attrition", 
		"troy_main_hero_unit_charge",
		"troy_hist_hero_bodyguard_morale_greater_spec",
		"troy_main_hero_campaign_replenishment", 
		"troy_hist_hero_trj_hector_defender_veteran_bodyguard_heavy_trojan_spearmen"},
		bodyguard_unit = "troy_hist_hero_trj_hector_defender_veteran_bodyguard_heavy_trojan_spearmen", -- used only in UI
	},
	--18
	...
	["troy_adi_dan_dolopians_champion"] = {
		...
		"troy_main_hero_campaign_post_battle",
		"troy_main_hero_unit_vigour_loss_reduction", "troy_main_hero_unit_vigour_loss_reduction_spec_recovery",
		"troy_main_hero_ability_terrify", "troy_main_hero_ability_terrify_spec_range",
		"troy_hist_hero_bodyguard_bloodthirst_spec", "troy_hist_hero_bodyguard_bloodthirst_spec_in_battle",
		"troy_main_hero_campaign_replenishment", "troy_main_hero_campaign_replenishment_spec_enemy",
		"troy_hist_hero_bodyguard_attack_spec_2", 
		"troy_hist_hero_bodyguard_ach_fighter_vanquisher_armoured_swordsmen"},
		...
		bodyguard_unit = "troy_hist_hero_ach_fighter_vanquisher_bodyguard_dendra_swordsmen", -- used only in UI
	},
	--20
	["troy_adi_trj_lycia_champion"] = {
		...
		"troy_hist_hero_bodyguard_morale_greater_spec",
		"troy_main_hero_ability_bulwark", "troy_main_hero_ability_bulwark_spec_armour",
		"troy_main_hero_campaign_recruitment_capacity",
		"troy_hist_hero_bodyguard_armour_spec", "troy_hist_hero_bodyguard_defence_spec_2",
		"troy_main_hero_unit_speed", 
		"troy_main_hero_campaign_ambush_success_defence", 
		"troy_hist_hero_trj_defender_companion_bodyguard_heavy_eastern_spearmen"},
		bodyguard_unit = "troy_hist_hero_trj_defender_companion_bodyguard_heavy_eastern_spearmen", -- used only in UI
	},
	--21
	["troy_adi_trj_penthesilea_champion"] = {
		...
		"troy_main_hero_unit_ammunition", "troy_main_hero_unit_ammunition_spec_attack_speed_missile_resistance_ranged", 
		"troy_main_hero_campaign_post_battle",
		"troy_main_hero_unit_missile_damage", 
		"troy_main_hero_unit_range", "troy_main_hero_unit_range_spec_archers", 
		"troy_dlc1_hero_campaign_razing",
		"troy_main_hero_unit_leadership", "troy_main_hero_unit_leadership_spec_spears",
		"troy_main_hero_ability_inspired_shots", "troy_main_hero_ability_inspired_shots_spec_damage",
		"troy_main_hero_campaign_campaign_movement", "troy_main_hero_campaign_campaign_movement_spec_land", 
		"troy_hist_hero_ama_penthesilea_archer_skirmisher_bodyguard_mounted_huntress"},
		bodyguard_unit = "troy_hist_hero_ama_penthesilea_archer_skirmisher_bodyguard_mounted_huntress", -- used only in UI
	},
	--22
	["troy_adi_dan_mycenae_champion"] = {
		...
		spawn_level = 9,
		spawn_skills = {"troy_main_hero_ability_find_cover", "troy_main_hero_ability_find_cover_spec_resistance",
		"troy_hist_hero_bodyguard_defence_spec_2", 
		"troy_main_hero_campaign_happiness_growth", 
		"troy_main_hero_unit_range", "troy_main_hero_unit_range_spec_archers", 
		"troy_hist_hero_bodyguard_armour_spec", "troy_hist_hero_bodyguard_missile_resist_greater_spec", 
		"troy_main_hero_unit_missile_damage", "troy_main_hero_unit_missile_damage_spec_ranged_experience_per_turn",
		"troy_hist_hero_bodyguard_ach_defender_protector_armoured_spearmen"},
		--"troy_main_hero_unit_missile_damage_spec_ranged_experience_per_turn",
		bodyguard_unit = "troy_hist_hero_ach_defender_protector_bodyguard_dendra_spearmen", -- used only in UI
	},
...
ajax_challenge_ai_units = {
	...
	[60] = { --[["troy_adi_champion_boreas", --]]"troy_adi_champion_aloeus" },
	[75] = { "troy_adi_champion_chromis", "troy_adi_champion_triopas" --[[, "troy_adi_champion_phorcys"--]] },
	[90] = { --[["troy_adi_champion_archelochos", --]]"troy_adi_champion_neoptolemus", "troy_adi_champion_alcibie" },
	[105] = { --[["troy_adi_champion_aeacides", "troy_adi_champion_stratichus", --]]"troy_adi_champion_glaucus" },
}
