...
achievements = {
	...
	mission_succeeded = {
		...
		by_mission_key = {
			...
			phar_map_ach_ult_victory_ninurta = {
				missions = { "phar_map_campaign_victory_ultimate_ninurta" },
			},

			phar_map_ach_ult_victory_babylon = {
				missions = { "phar_map_campaign_victory_ultimate_babylon" },
			},

			phar_map_ach_ult_victory_priam = {
				missions = { "phar_map_campaign_victory_ultimate_priam" },
			},

			phar_map_ach_ult_victory_agamemnon = {
				missions = { "phar_map_campaign_victory_ultimate_agamemnon" },
			},

			phar_map_ach_ult_victory_merneptah = {
				missions = { "phar_map_campaign_victory_ultimate_merneptah" },
			},

			phar_map_ach_ult_victory_setnakhte = {
				missions = { "phar_map_campaign_victory_ultimate_setnakhte" },
			},

			phar_map_ach_ult_victory_napata = {
				missions = { "phar_map_campaign_victory_ultimate_napata" },
			},

			phar_map_ach_ult_victory_bahariya = {
				missions = { "phar_map_campaign_victory_ultimate_bahariya" },
			},

			phar_map_ach_ult_victory_dungul = {
				missions = { "phar_map_campaign_victory_ultimate_dungul" },
			},

			phar_map_ach_ult_victory_carchemish = {
				missions = { "phar_map_campaign_victory_ultimate_carchemish" },
			},

			phar_map_ach_ult_victory_trj_hippolyta = {
				missions = { "phar_map_campaign_victory_ultimate_trj_hippolyta" },
			},

			phar_map_ach_ult_victory_alashiya = {
				missions = { "phar_map_campaign_victory_ultimate_alashiya" },
			},

			phar_map_ach_ult_victory_malidiya = {
				missions = { "phar_map_campaign_victory_ultimate_malidiya" },
			},

			phar_map_ach_ult_victory_sangarian_phrygians = {
				missions = { "phar_map_campaign_victory_ultimate_sangarian_phrygians" },
			},
			
			phar_map_ach_ult_victory_ugarit = {
				missions = { "phar_map_campaign_victory_ultimate_ugarit" },
			},

			phar_map_ach_ult_victory_ashkelon = {
				missions = { "phar_map_campaign_victory_ultimate_ashkelon" },
			},

			phar_map_ach_ult_victory_byblos = {
				missions = { "phar_map_campaign_victory_ultimate_byblos" },
			},

			phar_map_ach_ult_victory_damascus = {
				missions = { "phar_map_campaign_victory_ultimate_damascus" },
			},

			phar_map_ach_ult_victory_emar = {
				missions = { "phar_map_campaign_victory_ultimate_emar" },
			},

			phar_map_ach_ult_victory_assyria = {
				missions = { "phar_map_campaign_victory_ultimate_assyria" },
			},

			phar_map_ach_ult_victory_igihalkid = {
				missions = { "phar_map_campaign_victory_ultimate_igihalkid" },
			},

			phar_map_ach_ult_victory_lullubi = {
				missions = { "phar_map_campaign_victory_ultimate_lullubi" },
			},

			phar_map_ach_ult_victory_shubru = {
				missions = { "phar_map_campaign_victory_ultimate_shubru" },
			},

			phar_map_ach_ult_victory_sutu = {
				missions = { "phar_map_campaign_victory_ultimate_sutu" },
			},

			phar_map_ach_ult_victory_dan_achilles = {
				missions = { "phar_map_campaign_victory_ultimate_dan_achilles" },
			},

			phar_map_ach_ult_victory_dan_ithaca = {
				missions = { "phar_map_campaign_victory_ultimate_dan_ithaca" },
			},

			phar_map_ach_ult_victory_trj_lycia = {
				missions = { "phar_map_campaign_victory_ultimate_trj_lycia" },
			},

			phar_map_ach_ult_victory_trj_thrace = {
				missions = { "phar_map_campaign_victory_ultimate_trj_thrace" },
			},

			phar_map_ach_ult_victory_dan_boeotians = {
				missions = { "phar_map_campaign_victory_ultimate_dan_boeotians" },
			},
		},
	...
	raze_settlements = {
		phar_main_ach_irsu_raze_cult_centre = {
			...
			slot_template_key_prefixes = { "phar_main_major_poc_", "phar_map_major_poc_", "phar_map_major_primary_poc_" },
			count = 5,
		...
		phar_sea_ach_pleasures_of_war = {
			...
			slot_template_key_prefixes = { "phar_main_", "phar_map_" },
			count = 10,
