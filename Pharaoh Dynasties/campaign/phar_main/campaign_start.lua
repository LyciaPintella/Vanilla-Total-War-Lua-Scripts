...
function diplomacy_allowed_post_load_fixup()
	...
	if hatti_political_states:political_state() == "legitimacy_war" then
		local pretenders = hatti_political_states:get_great_king_pretenders()
	...
	elseif hatti_political_states:get_great_king_faction() then
		local great_king = hatti_political_states:get_great_king_faction()
		cm:force_diplomacy("faction:"..great_king, "all", "subjugate", true, false, false)
		cm:force_diplomacy("faction:"..great_king, "all", "become subject", false, true, false)
	end

	if egypt_political_states:political_state() == "legitimacy_war" then
		local pretenders = egypt_political_states:get_pharaoh_pretenders()
		for _, pretender_key in ipairs(pretenders) do
				cm:force_diplomacy("faction:"..pretender_key, "all", "subjugate", true, false, false)
				cm:force_diplomacy("faction:"..pretender_key, "all", "become subject", false, true, false)
		end
	elseif egypt_political_states:get_pharaoh_faction() then
		local pharaoh = egypt_political_states:get_pharaoh_faction()
		cm:force_diplomacy("faction:"..pharaoh, "all", "subjugate", true, false, false)
		cm:force_diplomacy("faction:"..pharaoh, "all", "become subject", false, true, false)
	end
end
