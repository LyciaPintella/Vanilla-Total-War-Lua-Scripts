...
bodyguard_as_ancillary_setup = {
	...
	link_table = 
	{
		...
		troy_achilles = { no_script_ancillary = true, },
		troy_agamemnon = { no_script_ancillary = true, },
		troy_menelaus = { no_script_ancillary = true, },
		troy_odysseus = { no_script_ancillary = true, },
		troy_hector = { no_script_ancillary = true, },
		troy_paris = { no_script_ancillary = true, },
		troy_aeneas = { no_script_ancillary = true, },
		troy_sarpedon = { no_script_ancillary = true, },
		troy_hippolyta = { no_script_ancillary = true, },
		troy_penthesilea = { no_script_ancillary = true, },
		troy_adi_ajax = { no_script_ancillary = true, },
		troy_adi_diomedes = { no_script_ancillary = true, },
	}	
}
...
function bodyguard_as_ancillary_setup:add_bodyguard_as_ancillary(context, char) 
	local ancillary = ""
	local character = nil
	if context then
	...
	if is_table(link_table) and is_table(link_table[subtype]) then
		if link_table[subtype].no_script_ancillary then
