...
function t3_turn_start()
		...
		function()
			...
			if sukkot_hero_1 and not sukkot_hero_1:is_null_interface() then
				...
				cm:move_character(
					...
					true,
					function()
						cm:replenish_action_points(cm:char_lookup_str(tut.player_faction_leader_fm_cqi))
	...
	cm:scroll_camera_from_current(true, 5, {430.166046, 703.797058, 16.346525, -0.029993, 10.282562})
