...
function t2_turn_start()
	...
	cm:clear_infotext()
	cm:scroll_camera_from_current(false, 4, {404.073181, 675.477844, 15.533713, -1.019229, 9.343366})
...
function t2_start_city_in_distress()
	...
	local cutscene_intro = campaign_cutscene:new_from_cindyscene(
		...
		"script/campaign/phar_main/factions/phar_camp_tutorial/scenes/phar_camp_tutorial_sq01_1.CindyScene",
		10,
		10,
	...
	cutscene_intro:set_restore_camera(3, 413.961639, 678.970947, 10, 0, 8)
...
function t2_hero_arrives_at_nekhel()
	...
	cm:scroll_camera_from_current(true, 5, {430.881226, 693.364258, 10.648074, 0.097234, 5.846888})		
