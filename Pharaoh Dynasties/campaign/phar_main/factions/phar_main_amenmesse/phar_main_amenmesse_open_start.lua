			...
			cm:start_intro_cutscene_on_loading_screen_dismissed(
				function()
					cm:show_benchmark_if_required(
						...
						"script/benchmarks/phar_campaign_benchmark/scenes/amenmesse_start_phar_main.CindyScene",-- benchmark cindy scene
...
function play_cutscene_intro()
	...
	cutscene_intro:action(
		function()
			...
			cutscene_intro:cindy_playback(string.format("script/campaign/phar_main/factions/phar_camp_flybys/scenes/phar_camp_flyby_ame_r01_s%s.CindyScene", id), 0, 2);
		end,
		0
	)
