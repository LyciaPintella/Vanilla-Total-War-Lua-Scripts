...
local hatti_political_states_config = {
	id = "hatti_political_states",
	...
	-- The chance of a CAI faction to start or join a legitimacy war
	chance_for_cai_to_start_legitimacy_war = 5,
	chance_for_cai_to_join_legitimacy_war = 15,
	cai_neutral_attitude_benchmark_value = 20,
	...
	-- Whether the pretenders who lost a legitimacy war become subjects of the new high king.
	failed_pretenders_become_subjects_of_new_ruler = false,

	vassal_occupation_option_key = "occupation_decision_vassal_or_subject",

	ancient_legacy_group_key = "hittite_legacies",
	...
	-- E.G. hatti_political_states_config.legitimacy_to_claim_crown.legitimacy_war
	-- will be 50 (or whatever number is set in the database)
	legitimacy_to_claim_crown = {
		legitimacy_war = "hatti_legitimacy_needed_to_join_great_king_war",
		stable = "hatti_legitimacy_needed_to_start_great_king_war",
	},
	...
	starting_ruler_faction_key = "phar_main_suppiluliuma",
	...
	starting_ruler_unlock_legacy = true,
	...
	event_info = {
		...
		legitimacy_war_start = {
			...
			secondary_detail = "",
			text = "ui_text_replacements_localised_text_phar_main_event_feed_string_legitimacy_war_start_hit_secondary_detail",
		...
		legitimacy_war_end = {
			...
			secondary_detail = "",
			text = "ui_text_replacements_localised_text_phar_main_event_feed_string_legitimacy_war_end_hit_secondary_detail",
			event_pic_index = 2141,
		},
		...
		legitimacy_war_end_other = {
			title_key = "ui_text_replacements_localised_text_phar_main_event_feed_string_legitimacy_war_end_title",
			secondary_detail = "",
			text = "ui_text_replacements_localised_text_phar_main_event_feed_string_legitimacy_war_end_hit_other_secondary_detail",
			event_pic_index = 2141,
		},
		...
		-- This appears for the player when on other paths and a Hittite civil war breaks out
		notify_other_paths_of_legitimacy_war = {
			title_key = "ui_text_replacements_localised_text_phar_main_event_feed_string_hittite_legitimacy_war_start_other_paths_title",
			secondary_detail = "",
			text = "ui_text_replacements_localised_text_phar_main_event_feed_string_hittite_legitimacy_war_start_other_paths_secondary_detail",
			event_pic_index = 2141,
		},
	},
	...
	legitimacy_war_start_movie_name = "phar_main_hatti_legitimacy_war_start.ca_vp8",
	legitimacy_war_end_movie_name = "phar_main_hatti_legitimacy_war_end.ca_vp8",
	...
	ui = {
		...
		war_started_notification = {
			title_key = "ui_text_replacements_localised_text_hatti_legitimacy_war_started_notification_title_key",
			text_key = "ui_text_replacements_localised_text_hatti_legitimacy_war_started_notification_text_key",
			state = "hatti_war",
		},

		war_joined_notification = {
			title_key = "ui_text_replacements_localised_text_hatti_legitimacy_war_joined_notification_title_key",
			text_key = "ui_text_replacements_localised_text_hatti_legitimacy_war_joined_notification_text_key",
			state = "hatti_joined",
		},

		war_ended_notification = {
			title_key = "ui_text_replacements_localised_text_hatti_legitimacy_war_ended_notification_title_key",
			text_key = "ui_text_replacements_localised_text_hatti_legitimacy_war_ended_notification_text_key",
			state = "hatti_peace",
		},

		court_leader_localized_name = "Great King",
	},
}

hatti_political_states = {
	config = hatti_political_states_config,
	...
	is_great_king = function(self, faction_key)
		return self:is_ruler(faction_key)
	end,
	...
	get_great_king_faction = function(self)
		return self:get_ruler_faction()
	end,

	is_sitting_great_king = function(self, faction_key)
		return self:is_sitting_ruler(faction_key)
	end,

	get_great_king_pretenders = function(self)
		return self.persistent.pretenders
	end,
}

hatti_political_states = crown:create_mechanic_from_type(political_states_system, hatti_political_states)
