...
local hatti_legitimacy_config = {
	id = "hatti_legitimacy",
	resource_key = "phar_hatti_legitimacy",
	dynasty_line_key = "phar_hatti_legitimacy",

	-- Sacred lands
	sacred_lands_factor = "phar_hatti_legitimacy_sacred_hatti_lands",

	-- Starting bonus
	starting_bonus_factor = "phar_hatti_legitimacy_rightful_claimant",

	-- Battles
	battle_factor = "phar_hatti_legitimacy_battle",
	battle_legitimacy_multiplier_scripted_bonus_value_id = "scripted_battle_legitimacy_multiplier",

	-- Regions
	region_lost_factor = "phar_hatti_legitimacy_region_conquer",

	-- Ancillaries
	ancillaries_factor = "phar_hatti_legitimacy_ancillaries",

	-- Settlement Buildings
	building_factor = "phar_hatti_legitimacy_buildings",
	legitimacy_from_buildings_scripted_bonus_value = "scripted_legitimacy_from_buildings",

	-- Monuments
	monument_factor = "phar_hatti_legitimacy_monuments",
	...
	allies_factor = "phar_hatti_legitimacy_ally",

	-- Points of Interest (POIs) and other ERS buildings
	ers_factor = "phar_hatti_legitimacy_external_region_buildings",
	...
	-- Court
	court_position_factor = "phar_hatti_legitimacy_court_position",
	court_plots_factor = "phar_map_court_decay",

	-- Minimum amount of sacred regions to have legitimacy be active for the faction.
	-- For programmers/tech design: This number can be overridden for specific factions using hatti_legitimacy:override_min_sacred_regions_for_faction(faction_key, new_min)
	...
	legitimacy_decay = {
...

		{
			amount = 1,
			portion = 0.1,
			factor = "phar_hatti_legitimacy_battle",
			effect_bundle = "phar_main_hatti_legitimacy_battle_decay",
			stop_at = 0,
...

		{
			...
			effect_bundle = "phar_map_hatti_legitimacy_court_decay",
			stop_at = 0,
			ai_multiplier = 0.7,
		},
	},
	...
	sources = {
		...
		battle_won = {
			...
			legitimacy_per_strength_base = 9,
		...
		local_deities = {
			...
			legitimacy_path_region_name = "{{tr:ui_text_replacements_localised_text_phar_map_pharaohs_crown_favoured_deity_culture_name_hatti}}",
	...
	ai_faction_multiplier_per_factor = {
		["phar_hatti_legitimacy_battle"] = 1.15,
	},
	...
	starting_amounts = {
		...
		{
			faction_key = "phar_main_cibyra",
			starting_amount = 4,	
		},

		{
			faction_key = "phar_main_hubishna",
			starting_amount = 4,	
		},

		{
			faction_key = "phar_main_kizzuwatna",
			starting_amount = 4,	
		},
		
		{
			faction_key = "phar_main_larawanda",
			starting_amount = 4,	
		},

		{
			faction_key = "phar_main_parha",
			starting_amount = 4,	
		},

		{
			faction_key = "phar_main_ancyra",
			starting_amount = 4,	
		},

		{
			faction_key = "phar_main_carchemish",
			starting_amount = 4,	
		},

		{
			faction_key = "phar_main_kanesh",
			starting_amount = 4,	
		},

		{
			faction_key = "phar_main_kummanni",
			starting_amount = 4,	
		},

		{
			faction_key = "phar_main_malidiya",
			starting_amount = 4,	
		},

		{
			faction_key = "phar_main_purushanda",
			starting_amount = 4,	
		},

		{
			faction_key = "phar_main_sapinuwa",
			starting_amount = 4,	
		},

		{
			faction_key = "phar_main_tuwana",
			starting_amount = 4,	
		},
	...
	ui = {
		...
		shared_state_sacred_regions_to_unlock_legitimacy = "num_sacred_hittite_lands_to_unlock_legitimacy",
		shared_state_sacred_regions_to_unlock_legitimacy_for_faction = "num_sacred_hittite_lands_to_unlock_legitimacy",
		shared_state_last_legitimacy_change_was_positive = "last_hatti_legitimacy_change_was_positive",

		tooltip_title = "hittite legitimacy",
		tooltip_description = "hittite legitimacy",

		sources = {
			{
				name_key = "campaign_localised_strings_string_legitimacy_factor_battles",
				factors_keys = { "phar_hatti_legitimacy_battle" },
				tooltip_key = "tooltip_phar_crown_legitimacy_source_hatti_battle",
			},
			{
				name_key = "campaign_localised_strings_string_legitimacy_factor_sacred_lands",
				factors_keys = { "phar_hatti_legitimacy_sacred_hatti_lands" },
				item_display_text = "uied_component_texts_localised_string_dy_title_NewState_Text_3d58e6bc",
				tooltip_key = "tooltip_phar_crown_legitimacy_source_hatti_sacred_land",
			},
			{
				name_key = "campaign_localised_strings_string_legitimacy_factor_monuments",
				factors_keys = { "phar_hatti_legitimacy_monuments" },
				item_display_text = "uied_component_texts_localised_string_dy_title_NewState_Text_3d58e6bc",
				tooltip_key = "tooltip_phar_crown_legitimacy_source_hatti_monument",
			},
			{
				name_key = "campaign_localised_strings_string_legitimacy_factor_buildings",
				factors_keys = { "phar_hatti_legitimacy_buildings" },
				tooltip_key = "tooltip_phar_crown_legitimacy_source_hatti_building",
			},
			{
				name_key = "campaign_localised_strings_string_legitimacy_factor_landmarks",
				factors_keys = { "phar_hatti_legitimacy_external_region_buildings" },
				tooltip_key = "tooltip_phar_crown_legitimacy_source_hatti_poi",
			},
			{
				name_key = "campaign_localised_strings_string_legitimacy_factor_character",
				factors_keys = { "phar_hatti_legitimacy_rightful_claimant", "phar_hatti_legitimacy_ancillaries", "phar_hatti_legitimacy_court_position" },
				item_display_text = "{{tr:uied_component_texts_localised_string_dy_title_NewState_Text_5d393ad7}}",
				tooltip_key = "tooltip_phar_crown_legitimacy_source_hatti_character",
			},
			-- {
			...
			-- },
			{
				...
				tooltip_key = "tooltip_phar_crown_legitimacy_source_hatti_court_intrigue",
			},
			{
				name_key = "campaign_localised_strings_string_legitimacy_factor_allies",
				factors_keys = { "phar_hatti_legitimacy_ally" },
				item_display_text = "{{tr:uied_component_texts_localised_string_dy_title_NewState_Text_5be9fa27}}",
				tooltip_key = "tooltip_phar_crown_legitimacy_source_hatti_decree",
			},
			{
				...
				tooltip_key = "tooltip_phar_crown_legitimacy_source_hatti_deities",
			},
		},

		tooltip_value_breakdown_cco_id = "tooltip_value_breakdown_legitimacy",

		legacy_button_tooltip = "{{tr:uied_component_texts_localised_string_button_fm_phar_pharaoh_crown_tooltip_hittite}}",
	},
}

hatti_legitimacy = {
	config = hatti_legitimacy_config,

	post_init = function(self)
		self.powers_system = great_king_powers
		self.political_states_system = hatti_political_states
		self.sacred_lands = sacred_hatti_lands
		self.special_ancillary_system = great_kings_regalia

		legitimacy_choice:register_legitimacy_object(self)
	end,
}

hatti_legitimacy = crown:create_mechanic_from_type(legitimacy_system, hatti_legitimacy)
