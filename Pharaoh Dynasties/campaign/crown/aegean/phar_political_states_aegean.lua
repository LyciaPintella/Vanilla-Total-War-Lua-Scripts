...
local aegean_political_states_config = {
	id = "aegean_political_states",
	...
	-- For Aegeans, the first Legitimacy war starts from the get go
	...
	ancient_legacy_group_key = "aegean_legacies",
	...
	-- E.G. aegean_political_states_config.legitimacy_to_claim_crown.legitimacy_war
	-- will be 50 (or whatever number is set in the database)
	legitimacy_to_claim_crown = {
		legitimacy_war = "legitimacy_needed_to_join_aegean_war",
		stable = "legitimacy_needed_to_start_aegean_war",
	},
	...
	starting_ruler_faction_key = "troy_main_trj_troy",
	...
	-- starting_war_min_num_pretenders = 4,
	...
	event_info = {
		...
		legitimacy_war_start = {
			...
			secondary_detail = "",
			text = "ui_text_replacements_localised_text_phar_map_event_feed_string_aegean_legitimacy_war_start_other_paths_secondary_detail",
		...
		legitimacy_war_end = {
			title_key = "ui_text_replacements_localised_text_aegea_legitimacy_war_ended_notification_title_key",
			secondary_detail = "",
			text = "ui_text_replacements_localised_text_aegea_legitimacy_war_ended_notification_text_key",
			event_pic_index = 2140,
		},
		...
		legitimacy_war_end_other = {
			...
			secondary_detail = "",
			text = "ui_text_replacements_localised_text_phar_map_event_feed_string_legitimacy_war_end_aegea_other_secondary_detail",
			event_pic_index = 2140,
		},
		...
		-- This appears for the player when on other paths and an Aegean civil war breaks out
		notify_other_paths_of_legitimacy_war = {
			title_key = "ui_text_replacements_localised_text_phar_map_event_feed_string_aegean_legitimacy_war_start_other_paths_title",
			secondary_detail = "",
			text = "ui_text_replacements_localised_text_phar_map_event_feed_string_aegean_legitimacy_war_start_other_paths_secondary_detail",
	...
	legitimacy_war_start_movie_name = "phar_map_aegea_legitimacy_war_start.ca_vp8",
	legitimacy_war_end_movie_name = "phar_map_aegea_legitimacy_war_end.ca_vp8",
	...
	ui = {
		...
		war_started_notification = {
			title_key = "ui_text_replacements_localised_text_aegea_legitimacy_war_started_notification_title_key",
			text_key = "ui_text_replacements_localised_text_aegea_legitimacy_war_started_notification_text_key",
			state = "aegean_war",
		},

		war_joined_notification = {
			title_key = "ui_text_replacements_localised_text_aegea_legitimacy_war_joined_notification_title_key",
			text_key = "ui_text_replacements_localised_text_aegea_legitimacy_war_joined_notification_text_key",
			state = "aegean_joined",
		},

		war_ended_notification = {
			title_key = "ui_text_replacements_localised_text_aegea_legitimacy_war_ended_notification_title_key",
			text_key = "ui_text_replacements_localised_text_aegea_legitimacy_war_ended_notification_text_key",
			state = "aegean_peace",
		},

		court_leader_localized_name = "Wanax",
	},
}

aegean_political_states = {
	config = aegean_political_states_config,
...
aegean_political_states = crown:create_mechanic_from_type(political_states_system, aegean_political_states)
