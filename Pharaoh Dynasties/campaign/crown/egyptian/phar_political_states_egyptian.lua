...
local egypt_political_states_config = {
	id = "political_states",
	...
	ancient_legacy_group_key = "egyptian_legacies",
	...
	-- E.G. egypt_political_states_config.legitimacy_to_claim_crown.legitimacy_war
	-- will be 50 (or whatever number is set in the database)
	legitimacy_to_claim_crown = {
		legitimacy_war = "legitimacy_needed_to_join_pharaoh_war",
		stable = "legitimacy_needed_to_start_pharaoh_war",
	},
	...
	-- Scripted event that one happens once
	starting_ruler_faction_key = "phar_main_merneptah",
	--starting_faction_leader_death_turn = 22,
	...
	event_info = {
		...
		legitimacy_war_start = {
			...
			secondary_detail = "",
			text = "ui_text_replacements_localised_text_phar_main_event_feed_string_legitimacy_war_start_egy_secondary_detail",
		...
		legitimacy_war_end = {
			...
			secondary_detail = "",
			text = "ui_text_replacements_localised_text_phar_main_event_feed_string_legitimacy_war_end_egy_secondary_detail",
			event_pic_index = 2140,
		},
		...
		legitimacy_war_end_other = {
			title_key = "ui_text_replacements_localised_text_phar_main_event_feed_string_legitimacy_war_end_title",
			secondary_detail = "",
			text = "ui_text_replacements_localised_text_phar_main_event_feed_string_legitimacy_war_end_egy_other_secondary_detail",
			event_pic_index = 2140,
		},
		...
		-- This appears for the player when on other paths and an Egyptian civil war breaks out
		notify_other_paths_of_legitimacy_war = {
			title_key = "ui_text_replacements_localised_text_phar_main_event_feed_string_egyptian_legitimacy_war_start_other_paths_title",
			secondary_detail = "",
			text = "ui_text_replacements_localised_text_phar_main_event_feed_string_egyptian_legitimacy_war_start_other_paths_secondary_detail",
	...
	legitimacy_war_start_movie_name = "phar_main_egypt_legitimacy_war_start.ca_vp8",
	legitimacy_war_end_movie_name = "phar_main_egypt_legitimacy_war_end.ca_vp8",
	starting_ruler_death_movie_name = "phar_main_egypt_starting_ruler_death.ca_vp8",
	...
	ui = {
		...
		war_started_notification = {
			title_key = "ui_text_replacements_localised_text_egypt_legitimacy_war_started_notification_title_key",
			text_key = "ui_text_replacements_localised_text_egypt_legitimacy_war_started_notification_text_key",
			state = "egypt_war",
		},

		war_joined_notification = {
			title_key = "ui_text_replacements_localised_text_egypt_legitimacy_war_joined_notification_title_key",
			text_key = "ui_text_replacements_localised_text_egypt_legitimacy_war_joined_notification_text_key",
			state = "egypt_joined",
		},

		war_ended_notification = {
			title_key = "ui_text_replacements_localised_text_egypt_legitimacy_war_ended_notification_title_key",
			text_key = "ui_text_replacements_localised_text_egypt_legitimacy_war_ended_notification_text_key",
			state = "egypt_peace",
		},

		court_leader_localized_name = "Pharaoh",
	},
}

egypt_political_states = {
	config = egypt_political_states_config,
	...
	is_pharaoh = function(self, faction_key)
		return self:is_ruler(faction_key)
	end,

	get_pharaoh_faction = function(self)
		return self:get_ruler_faction()
	end,

	is_sitting_pharaoh = function(self, faction_key)
		return self:is_sitting_ruler(faction_key)
	end,

	get_pharaoh_pretenders = function(self)
		return self.persistent.pretenders
	end,
}

egypt_political_states = crown:create_mechanic_from_type(political_states_system, egypt_political_states)
