...
cam_start_x = 542.87237548828;
cam_start_y = 205.65353393555;
cam_start_d = 6.710209369659;
cam_start_b = 0;
cam_start_h = 3.7837018966675;
...
cm:add_first_tick_callback_sp_new(
	function() 
		...
		cm:set_camera_position(256.418854, 52.400101, 14.672362, 0, 16.864883);
		
		cm:start_intro_cutscene_on_loading_screen_dismissed(cutscene_intro_sarpedon)
	end
);
...
function cutscene_intro_sarpedon()

	local advice_to_play = {};
	advice_to_play[1] = "troy_cam_faction_intro_homer_sar_01"
	advice_to_play[2] = "troy_cam_faction_intro_homer_sar_03"
	advice_to_play[3] = "troy_cam_faction_intro_homer_sar_02"
	advice_to_play[4] = "troy_cam_faction_intro_homer_sar_04"
	advice_to_play[5] = "troy_cam_faction_intro_homer_sar_05"
	advice_to_play[6] = "troy_cam_faction_intro_homer_sar_06"
	advice_to_play[7] = "troy_cam_faction_intro_homer_sar_07"
	advice_to_play[8] = "troy_cam_faction_intro_homer_sar_08"
	advice_to_play[9] = "troy_cam_faction_intro_homer_sar_09"

	local subtitle_to_play = {};
	subtitle_to_play[1] = "troy_sub_intro_sarpedon"
--	subtitle_to_play[1] = "troy_sub_faction_intro_homer_sar_01"
--	subtitle_to_play[2] = "troy_sub_faction_intro_homer_sar_02"
--	subtitle_to_play[3] = "troy_sub_faction_intro_homer_sar_04"
--	subtitle_to_play[4] = "troy_sub_faction_intro_homer_sar_05"
--	subtitle_to_play[5] = "troy_sub_faction_intro_homer_sar_06"
--	subtitle_to_play[6] = "troy_sub_faction_intro_homer_sar_07"
--	subtitle_to_play[7] = "troy_sub_faction_intro_homer_sar_08"
--	subtitle_to_play[8] = "troy_sub_faction_intro_homer_sar_09"
	...
	cutscene_intro:action(
		function()
			...
			cutscene_intro:cindy_playback("script/campaign/main_troy/factions/flyby_cinematics/scenes/flyby_serpedonmap_r01_s01.CindyScene", 4, 6);
		end,
		0
	)
	...
	cutscene_intro:action(
		function()
			cm:characters_forced_invisible({sarpedon_forename_id}, false);
		end,
		40
	);
	...
	cutscene_intro:action(
		function()
			...
			cm:callback( function() cm:hide_subtitles() end, 4.3);
		end,
		21.5
	);
...
--		function()
--			cm:show_subtitle(subtitle_to_play[1], false, true);
--			cm:callback( function() cm:hide_subtitles() end, 24.5)
--		end,
--		2
--	);
...
--			cm:callback( function() cm:hide_subtitles() end, 33.8)
--		end,
--		27
--	);
...
--			cm:callback( function() cm:hide_subtitles() end, 51)
--		end,
--		43
--	);
...
--			cm:callback( function() cm:hide_subtitles() end, 64)
--		end,
--		51
--	);
...
--			cm:callback( function() cm:hide_subtitles() end, 75)
--		end,
--		64
--	);
...
--			cm:callback( function() cm:hide_subtitles() end, 82.5)
--		end,
--		75
--	);
...
--			cm:callback( function() cm:hide_subtitles() end, 89.5)
--		end,
--		82.5
--	);
