...
local early_game_mission_overrides = {
	...
	initial_quest_key = "troy_main_sarpedon_quest_stage_0",
...
start_early_game_shared_missions(
	...
	"troy_early_game_trj_sarpedon",					-- substr that is used to form early game mission keys, when concatenated with strings like "_defeat_enemy_army_1" or "_recruit_full_army_1"
...
--[[
start_early_game_missions_sarpedon(
	cm:get_local_faction_name(),							-- key of local player faction
	"troy_early_game_trj_sarpedon",					-- substr that is used to form early game mission keys, when concatenated with strings like "_defeat_enemy_army_1" or "_recruit_full_army_1"
	early_game_mission_overrides					-- table of overrides
);
