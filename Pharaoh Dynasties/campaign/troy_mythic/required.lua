...
package.path = package.path .. ";data/script/campaign/main_troy/?.lua"
package.path = package.path .. ";data/script/campaign/troy_historical/?.lua"
package.path = package.path .. ";data/script/campaign/troy_mythic/?.lua"
...
force_require("troy_campaign_blood_markers")
force_require("troy_campaign_setup")
force_require("troy_constants")
...
force_require("troy_campaign_interventions")
...
require("troy_victory_conditions")
require("troy_favour_history")
require("troy_tutorial_battles")
require("troy_minimalistic_text_pointers")
require("troy_taunt_effect")
require("troy_pet_the_cerberus")
require("troy_mythic_monsters_skills")
require("troy_mythic_monsters_common")
require("troy_mythic_monsters_expeditions")
require("troy_mythic_monsters_selection")
require("troy_mythic_monsters_missions")
