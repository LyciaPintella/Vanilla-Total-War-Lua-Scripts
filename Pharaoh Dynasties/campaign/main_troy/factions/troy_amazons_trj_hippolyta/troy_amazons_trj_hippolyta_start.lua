...
cam_start_x = 462.16873168945;
cam_start_y = 278.47402954102;
cam_start_d = 12.026794433594;
cam_start_b = 0;
cam_start_h = 4.1596298217773;
...
function start_cutscene_intro()
	...
	advice_to_play[1] = "troy_cam_faction_intro_homer_hip_01"
	advice_to_play[2] = "troy_cam_faction_intro_homer_hip_02"
	advice_to_play[3] = "troy_cam_faction_intro_homer_hip_03"
	advice_to_play[4] = "troy_cam_faction_intro_homer_hip_04"
	advice_to_play[5] = "troy_cam_faction_intro_homer_hip_05"

	local subtitle_to_play = {};
	subtitle_to_play[1] = "troy_sub_intro_hector"
	subtitle_to_play[2] = "troy_sub_intro_hippolyta"
	--subtitle_to_play[1] = "troy_sub_faction_intro_homer_hip_01"
	--subtitle_to_play[2] = "troy_sub_faction_intro_homer_hip_02"
	--subtitle_to_play[3] = "troy_sub_faction_intro_homer_hip_03"
	--subtitle_to_play[4] = "troy_sub_faction_intro_homer_hip_04"
	--subtitle_to_play[5] = "troy_sub_faction_intro_homer_hip_05"
	...
	cutscene_intro:action(
		function()
			...
			cutscene_intro:cindy_playback("script/campaign/main_troy/factions/flyby_cinematics/scenes/flyby_hyppolitamap.CindyScene", 2, 2);
		end,
		0
	)
	...
	cutscene_intro:action(
		function()
			cm:characters_forced_invisible({hippolyta_forename_id}, false);
		end,
		48
	);
	...
	cutscene_intro:action(
		function()
			...
			cm:callback( function() cm:hide_subtitles() end, 4.2);
		end,
		10.5
	);
	...
	cutscene_intro:action(
		function()
			cm:show_subtitle(subtitle_to_play[2], false, true);
			cm:callback( function() cm:hide_subtitles() end, 6);
		end,
		37
	);
	...
	--cutscene_intro:action(
		--function()
			...
			--cm:callback( function() cm:hide_subtitles() end, 37)
		--end,
		--25
	--);
	...
	--cutscene_intro:action(
		--function()
			...
			--cm:callback( function() cm:hide_subtitles() end, 56)
		--end,
		--44
	--);
