...
cam_start_x = 104.64499664307;
cam_start_y = 251.08200073242;
cam_start_d = 12.143367767334;
cam_start_b = 0;
cam_start_h = 7

ithaca_starting_camera_position = {
	cam_start_x,
	cam_start_y,
	cam_start_d,
	cam_start_b,
...
drakomachos_forename_id = "1034152989";
...
cm:add_first_tick_callback_sp_new(
	function() 
		...
		cm:set_camera_position(86.265953, 231.577713, 15.365902, 0, 15.144009);
		
		cm:start_intro_cutscene_on_loading_screen_dismissed(cutscene_intro_odysseus)
	end
)
...
function cutscene_intro_odysseus()

	local advice_to_play = {};
	advice_to_play[1] = "troy_cam_faction_intro_homer_ody_01"
	advice_to_play[2] = "troy_cam_faction_intro_homer_ody_02"
	advice_to_play[3] = "troy_cam_faction_intro_homer_ody_03"
	advice_to_play[4] = "troy_cam_faction_intro_homer_ody_04"
	advice_to_play[5] = "troy_cam_faction_intro_homer_ody_05"
	advice_to_play[6] = "troy_cam_faction_intro_homer_ody_06"
	advice_to_play[7] = "troy_cam_faction_intro_homer_ody_07"

	local subtitle_to_play = {};
	subtitle_to_play[1] = "troy_sub_intro_menelaus"
	subtitle_to_play[2] = "troy_sub_intro_agamemnon"
	subtitle_to_play[3] = "troy_sub_intro_odysseus"
	--subtitle_to_play[1] = "troy_sub_faction_intro_homer_ody_01"
	--subtitle_to_play[2] = "troy_sub_faction_intro_homer_ody_02"
	--subtitle_to_play[3] = "troy_sub_faction_intro_homer_ody_03"
	--subtitle_to_play[4] = "troy_sub_faction_intro_homer_ody_04"
	--subtitle_to_play[5] = "troy_sub_faction_intro_homer_ody_05"
	--subtitle_to_play[6] = "troy_sub_faction_intro_homer_ody_06"
	--subtitle_to_play[7] = "troy_sub_faction_intro_homer_ody_07"
	...
	function()
		...
		--cm:callback(function() cm:set_camera_position(cam_start_x, cam_start_y, cam_start_d, cam_start_b, cam_start_h) end, 0.1);
	end,												-- end callback
	true
	)
	...
	cutscene_intro:action(
		function()
			...
			cutscene_intro:cindy_playback("script/campaign/main_troy/factions/flyby_cinematics/scenes/flyby_oddyseusmap_r01_s01.CindyScene", 4, 2);
		end,
		0
	)
	...
	cutscene_intro:action(
		function()
			cm:characters_forced_invisible({odysseus_forename_id}, false);
		end,
		72
	);
	...
	--cutscene_intro:action(
		--function()
			--cm:show_subtitle(subtitle_to_play[2], false, true);
			--cm:callback( function() cm:hide_subtitles() end, 22)
		--end,
		--13
	--);
	...
	--cutscene_intro:action(
		--function()
			...
			--cm:callback( function() cm:hide_subtitles() end, 36)
		--end,
		--28.6
	--);
	...
	--cutscene_intro:action(
		--function()
			...
			--cm:callback( function() cm:hide_subtitles() end, 44.5)
		--end,
		--36.1
	--);
	...
	--cutscene_intro:action(
		--function()
			...
			--cm:callback( function() cm:hide_subtitles() end, 50)
		--end,
		--44.6
	--);	
	...
	--cutscene_intro:action(
		--function()
			...
			--cm:callback( function() cm:hide_subtitles() end, 76)
		--end,
		--60.1
	--);		
