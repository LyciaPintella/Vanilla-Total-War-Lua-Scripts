...
function start_tutorial()
	...
	if core:svr_load_bool("sbool_player_selected_first_turn_intro_on_frontend") and not cm:get_saved_value("bool_is_ftue_mode") then
		...
		core:add_listener(
			...
			function() return cm:get_local_faction_name() == "troy_main_dan_mycenae" end,
			function()
...
function apply_random_active_overrides_on_load()
	...
	if ftue_random_active_overrides.offices_override == true then
		...
		cm:disable_shortcut("root", "show_fm_1", true)
		cm:disable_shortcut("root", "show_fm_2", true)
		cm:disable_shortcut("root", "show_fm_3", true)
	end
	...
	if ftue_random_active_overrides.divine_will_override == true then 
...
core:add_listener(
	...
	function(context) 
		...
		uim:override("hide_abandon_settlement"):unlock()
...
core:add_listener(
	...
	function(context) 
		...
		ftue_random_active_overrides.divine_will_override = false
	end,
	false
)
...
core:add_listener(
	...
	function(context)
		...
		cm:disable_shortcut("root", "show_fm_1", false)
		cm:disable_shortcut("root", "show_fm_2", false)
		cm:disable_shortcut("root", "show_fm_3", false)
	end,
	false
)
