...
-----------------------------------------------------------------------------------
-----------------------------------------------------------------------------------
--camera position in cindy format X:376.28100585938Y: 16.431915283203D: 341.70602416992B: 376.28100585938H: 0.63191932439804
...
function start_cutscene_intro()
	...
	advice_to_play[1] = "troy_adi_cam_faction_intro_homer_dio_01"
	advice_to_play[2] = "troy_adi_cam_faction_intro_homer_dio_02"
	advice_to_play[3] = "troy_adi_cam_faction_intro_homer_dio_03"
	advice_to_play[4] = "troy_adi_cam_faction_intro_homer_dio_04"
	advice_to_play[5] = "troy_adi_cam_faction_intro_homer_dio_05"
	advice_to_play[6] = "troy_adi_cam_faction_intro_homer_dio_06"
	advice_to_play[7] = "troy_adi_cam_faction_intro_homer_dio_07"

	local subtitle_to_play = {};
	subtitle_to_play[1] = "troy_sub_intro_hector"
	subtitle_to_play[2] = "troy_adi_sub_intro_diomedes"

	local cutscene_intro = campaign_cutscene:new(
		"intro_cutscene",									-- string name for this cutscene
		87,													-- length of cutscene in seconds
		function() 
	...
	cutscene_intro:action(
		function()
			...
			cutscene_intro:cindy_playback("script/campaign/main_troy/factions/flyby_cinematics/scenes/flyby_diomedes_r01_s01.CindyScene", 4, 2);
		end,
		0
	)
	...
	cutscene_intro:action(
		function()
			cm:characters_forced_invisible({diomedes_forename_id}, false);
		end,
		58
	);
