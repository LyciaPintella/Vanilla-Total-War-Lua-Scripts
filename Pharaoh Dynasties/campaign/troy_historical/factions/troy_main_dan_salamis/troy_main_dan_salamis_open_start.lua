...
local early_game_mission_overrides = {
	enemy_faction_key = "troy_main_dan_epidayrus",
	initial_quest_key = "troy_main_ajax_quest_stage_0",

	-- Ajax doesn't have an initial quest currently, so bypass it
	...
	hold_celebration_countdown_turns = 20,
...
start_early_game_shared_missions(
	...
	"troy_adi_early_game_dan_ajax",					-- substr that is used to form early game mission keys, when concatenated with strings like "_defeat_enemy_army_1" or "_recruit_full_army_1"
...
start_early_game_missions_ajax(
	cm:get_local_faction_name(),							-- key of local player faction
	"troy_adi_early_game_dan_ajax",					-- substr that is used to form early game mission keys, when concatenated with strings like "_defeat_enemy_army_1" or "_recruit_full_army_1"
	early_game_mission_overrides					-- table of overrides
);