...
cam_start_x = 374.63134765625;
cam_start_y = 438.25982666016;
cam_start_d = 10.047943115234;
cam_start_b = 0;
cam_start_h = 4.9191451072693;

dardania_starting_camera_position = {
	cam_start_x,
	cam_start_y,
	cam_start_d,
	cam_start_b,
...
cm:add_first_tick_callback_sp_new(
	function() 
		...
		cm:set_camera_position(211.528519, 138.397247, 15.04143, 0, 16.0);
		
		cm:start_intro_cutscene_on_loading_screen_dismissed(cutscene_intro_aeneas)
	end
);
...
function cutscene_intro_aeneas()

	local advice_to_play = {};
	advice_to_play[1] = "troy_cam_faction_intro_homer_aen_01"
	advice_to_play[2] = "troy_cam_faction_intro_homer_aen_02"
	advice_to_play[3] = "troy_cam_faction_intro_homer_aen_03"
	advice_to_play[4] = "troy_cam_faction_intro_homer_aen_04"
	advice_to_play[5] = "troy_cam_faction_intro_homer_aen_06"
	advice_to_play[6] = "troy_cam_faction_intro_homer_aen_07"
	advice_to_play[7] = "troy_cam_faction_intro_homer_aen_08"
	advice_to_play[8] = "troy_cam_faction_intro_homer_aen_09"
...
--	subtitle_to_play[4] = "troy_sub_faction_intro_homer_aen_06"
--	subtitle_to_play[5] = "troy_sub_faction_intro_homer_aen_07"
--	subtitle_to_play[6] = "troy_sub_faction_intro_homer_aen_08"
--	subtitle_to_play[7] = "troy_sub_faction_intro_homer_aen_09"

	local cutscene_intro = campaign_cutscene:new(
		"intro_cutscene",										-- string name for this cutscene
		95,													-- length of cutscene in seconds
		function()
	...
	cutscene_intro:action(
		function()
			...
			cutscene_intro:cindy_playback("script/campaign/main_troy/factions/flyby_cinematics/scenes/flyby_aeneasmap_r01_s01.CindyScene", 6, 2)
		end,
		0
	)
	...
	cutscene_intro:action(
		function()
			cm:characters_forced_invisible({aeneas_forename_id}, false);
		end,
		40
	);
...
--		function()
--			cm:show_subtitle(subtitle_to_play[2], false, true);
--			cm:callback( function() cm:hide_subtitles() end, 46)
--		end,
--		37
--	);
...
--		function()
--			cm:show_subtitle(subtitle_to_play[3], false, true);
--			cm:callback( function() cm:hide_subtitles() end, 57)
--		end,
--		46
--	);
...
--			cm:callback( function() cm:hide_subtitles() end, 67)
--		end,
--		57
--	);
...
--			cm:callback( function() cm:hide_subtitles() end, 86.5)
--		end,
--		74
--	);
...
--			cm:callback( function() cm:hide_subtitles() end, 92.8)
--		end,
--		86.5
--	);
