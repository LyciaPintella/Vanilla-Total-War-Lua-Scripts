...
local early_game_mission_overrides = {
	enemy_faction_key = "troy_main_dan_makaria",
	initial_quest_key = "troy_main_hector_quest_stage_0",
...
start_early_game_shared_missions(
	...
	"troy_early_game_trj_hector",					-- substr that is used to form early game mission keys, when concatenated with strings like "_defeat_enemy_army_1" or "_recruit_full_army_1"
