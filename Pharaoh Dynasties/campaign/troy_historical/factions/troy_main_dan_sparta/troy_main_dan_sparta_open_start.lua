...
local early_game_mission_overrides = {
	enemy_faction_key = "troy_main_dan_sparta_separatists",
	suppress_initial_quest = true,
	initial_quest_key = "troy_main_menelaus_quest_stage_0",
...
start_early_game_shared_missions(
	...
	"troy_early_game_dan_menelaus",					-- substr that is used to form early game mission keys, when concatenated with strings like "_defeat_enemy_army_1" or "_recruit_full_army_1"
...
--[[ 
start_early_game_missions_menelaus(
	cm:get_local_faction_name(),							-- key of local player faction
	"troy_early_game_dan_menelaus",					-- substr that is used to form early game mission keys, when concatenated with strings like "_defeat_enemy_army_1" or "_recruit_full_army_1"
	early_game_mission_overrides					-- table of overrides
);
