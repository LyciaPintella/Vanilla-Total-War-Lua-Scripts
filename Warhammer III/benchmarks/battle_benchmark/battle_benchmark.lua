...
function play_cutscene_intro()
	...
	cutscene_intro:action(function() cam:move_to(v(190.895111,430.682922,-228.460083),v(-45.761078,326.781403,-135.001999), 10, true, -1) end, 5000);
	
	--  / Broad Pan Over Towards Khorne Army & Artillery Impact.     
	cutscene_intro:action(function() cam:move_to(v(-22.08193,429.686584,-203.894455),v(-276.782074,326.615906,-197.557693), 6, true, -1) end, 17500);
	...
	-- / Zoom In
	cutscene_intro:action(function() cam:move_to(v(32.556694,425.282288,-207.27887),v(-163.492035,278.334106,-82.750458), 4, true, -1) end, 66000);
	
	-- / Panning Towards Hailstorm Spell & Pivoting To Get Rest of Battle In View.
	cutscene_intro:action(function() cam:move_to(v(27.778833,444.670319,-29.62044),v(-89.097778,279.525208,-215.639343), 5, true, -1) end, 75000);
