...
loading_screen_key_defeat = "wh3_main_survival_slaanesh_palace_defeat";
...
if num_realms_completed == 0 then
	loading_screen_win = "wh3_main_survival_slaanesh_palace_first_win";
elseif num_realms_completed == 1 then
	loading_screen_win = "wh3_main_survival_slaanesh_palace_second_win";
elseif num_realms_completed == 2 then
	loading_screen_win = "wh3_main_survival_slaanesh_palace_third_win";
elseif num_realms_completed == 3 then
	loading_screen_win = "wh3_main_survival_slaanesh_palace_fourth_win";
end
