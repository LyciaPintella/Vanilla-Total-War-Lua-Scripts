...
bm:force_custom_battle_result("wh3_survival_nurgle_victory", true);
bm:force_custom_battle_result("wh3_survival_nurgle_defeat", false);
...
sz_collection_4 = bm:get_spawn_zone_collection_by_name("attacker_stage_4_helpers", "attacker_stage_4_left", "attacker_stage_4_right");
...
local capture_point_01 = bm:capture_location_manager():capture_location_from_script_id("cp_blight_garden");
local capture_point_02 = bm:capture_location_manager():capture_location_from_script_id("cp_swampy_grounds");
local capture_point_03 = bm:capture_location_manager():capture_location_from_script_id("cp_overgrown_path");
...
gb:message_on_capture_location_capture_completed("cp_1_owned", "battle_start", "cp_blight_garden", nil, ga_ai_def_01, ga_player_01);
...
gb:message_on_capture_location_capture_completed("cp_2_owned", "ready_ai_wave_02", "cp_swampy_grounds", nil, ga_ai_def_01, ga_player_01);
gb:message_on_capture_location_capture_completed("cp_2_lost", "ready_ai_wave_02", "cp_swampy_grounds", nil, ga_player_01, ga_ai_def_01);
...
gb:message_on_capture_location_capture_completed("cp_3_owned", "ready_ai_wave_03", "cp_overgrown_path", nil, ga_ai_def_01, ga_player_01);
gb:message_on_capture_location_capture_completed("cp_3_lost", "ready_ai_wave_03", "cp_overgrown_path", nil, ga_player_01, ga_ai_def_01);
...
function teleport_def_01_units()
	...
	ga_ai_def_01.sunits:item(1).uc:teleport_to_location(v(122.54, -155.50), 185.0, 16.9);
	ga_ai_def_01.sunits:item(2).uc:teleport_to_location(v(140.58, -155.91), 185.0, 16.9);
	ga_ai_def_01.sunits:item(3).uc:teleport_to_location(v(108.42, -131.74), 185.0, 22.1);
	ga_ai_def_01.sunits:item(4).uc:teleport_to_location(v(132.41, -134.10), 185.0, 22.1);
	ga_ai_def_01.sunits:item(5).uc:teleport_to_location(v(156.39, -136.46), 185.0, 22.1);
	ga_ai_def_01.sunits:item(6).uc:teleport_to_location(v(136.66, -141.12), 235.0, 3.0);
end;
...
function teleport_def_02_units()
	...
	ga_ai_def_02.sunits:item(1).uc:teleport_to_location(v(156.30, 228.83), 180.0, 29.0); 
	ga_ai_def_02.sunits:item(2).uc:teleport_to_location(v(125.30, 229.34), 180.0, 29.0); 
	ga_ai_def_02.sunits:item(3).uc:teleport_to_location(v(94.31, 229.85), 180.0, 29.0); 
	ga_ai_def_02.sunits:item(4).uc:teleport_to_location(v(63.31, 230.36), 180.0, 29.0); 

	ga_ai_def_02.sunits:item(5).uc:teleport_to_location(v(130.26, 261.82), 180.0, 22.1);
	ga_ai_def_02.sunits:item(6).uc:teleport_to_location(v(87.79, 263.34), 180.0, 22.1);
end;
...
function teleport_def_03_units()
	...
	ga_ai_def_03.sunits:item(1).uc:teleport_to_location(v(76.99, 658.97), 180.0, 29.00);
	ga_ai_def_03.sunits:item(2).uc:teleport_to_location(v(45.99, 658.97), 180.0, 29.00);
	ga_ai_def_03.sunits:item(3).uc:teleport_to_location(v(14.99, 658.97), 180.0, 29.00);
	ga_ai_def_03.sunits:item(4).uc:teleport_to_location(v(-16.01, 658.97), 180.0, 29.00);

	ga_ai_def_03.sunits:item(5).uc:teleport_to_location(v(-2.86, 691.08), 180.0, 22.1);
	ga_ai_def_03.sunits:item(6).uc:teleport_to_location(v(63.87, 687.10), 180.0, 22.1);

	ga_ai_def_03.sunits:item(7).uc:teleport_to_location(v(31.83, 682.88), 180.0, 7.40); 
end;
...
function teleport_boss()
	...
	ga_ai_att_04.sunits:item(1).uc:teleport_to_location(v(128.05, 765.24), 180.0, 4.5);
...
-------DEFENDER 1-------
ga_ai_def_01:defend_on_message("battle_start" , 115, 240, 50);
...
ga_ai_def_02:defend_on_message("ready_ai_wave_02" , 130, -90, 50);
...
ga_ai_def_03:defend_on_message("ready_ai_wave_03" , 45, 690, 50);
...
gb:add_listener(
	...
	function()
		bm:set_locatable_objective(
			"wh3_survival_point_nur_garden", 
			v(50.68, 107.48, -164.46), 
			v(65.45, 83.24, -134.03), 
			1, 
			true
		);
	end
...
gb:complete_objective_on_message("cp_1_owned", "wh3_survival_point_nur_garden", 1000);
gb:remove_objective_on_message("1_1_deployed", "wh3_survival_point_nur_garden", 1000);

gb:add_listener(
	"obj_02",
	function()
		bm:set_locatable_objective(
			"wh3_survival_point_nur_swamp", 
			v(13.25, 143.19, 142.34), 
			v(164.20, 10.37, 326.73), 
			1, 
			true
		);
	end
...
gb:complete_objective_on_message("cp_2_owned", "wh3_survival_point_nur_swamp", 1000);
gb:remove_objective_on_message("2_1_deployed", "wh3_survival_point_nur_swamp", 1000);

gb:add_listener(
	"obj_03",
	function()
		bm:set_locatable_objective(
			"wh3_survival_point_nur_path", 
			v(5, 211.73, 531.50), 
			v(27.25, 62.84, 759.66), 
			1, 
			true
		);
	end
);
gb:complete_objective_on_message("cp_3_owned", "wh3_survival_point_nur_path", 1000);
gb:remove_objective_on_message("3_1_deployed", "wh3_survival_point_nur_path", 1000);

gb:set_objective_with_leader_on_message("reveal_cutscene_end", "wh3_survival_boss_nurgle", 1000);
gb:complete_objective_on_message("prepare_for_outro", "wh3_survival_boss_nurgle", 1000);
...
gb:set_objective_with_leader_on_message("1_1_deployed", "wh3_survival_wave_nurgle", 1000);
gb:complete_objective_on_message("ready_ai_wave_02", "wh3_survival_wave_nurgle", 1000);
gb:remove_objective_on_message("obj_02", "wh3_survival_wave_nurgle", 1000);

gb:set_objective_with_leader_on_message("2_1_deployed", "wh3_survival_wave_nurgle", 1000);
gb:complete_objective_on_message("ready_ai_wave_03", "wh3_survival_wave_nurgle", 1000);
gb:remove_objective_on_message("obj_03", "wh3_survival_wave_nurgle", 1000);

gb:add_listener(
	"4_deployed",
	function()
		if ga_ai_att_04.sunits:are_any_active_on_battlefield() == true then
			bm:set_objective_with_leader("wh3_survival_boss_nurgle");
		end;
	end,
	true
);
...
loading_screen_key_defeat = "wh3_main_survival_plague_mansion_defeat";
...
if num_realms_completed == 0 then
	loading_screen_win = "wh3_main_survival_plague_mansion_first_win";
elseif num_realms_completed == 1 then
	loading_screen_win = "wh3_main_survival_plague_mansion_second_win";
elseif num_realms_completed == 2 then
	loading_screen_win = "wh3_main_survival_plague_mansion_third_win";
elseif num_realms_completed == 3 then
	loading_screen_win = "wh3_main_survival_plague_mansion_fourth_win";
end
