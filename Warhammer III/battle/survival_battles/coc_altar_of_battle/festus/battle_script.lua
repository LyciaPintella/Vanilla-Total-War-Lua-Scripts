...
intro_cinematic_file = "script\\battle\\survival_battles\\_cutscene\\managers\\coc_altar_festus_phase_one.CindySceneManager";
...
wh3_intro_sfx_00 = new_sfx("Play_Movie_WH3_DLC20_QB_Altar_Of_Battle_Festus_Intro");		

wh3_intro_sfx_01 = new_sfx("play_wh3_dlc20_qb_festus_altar_of_battle_intro_001");
wh3_intro_sfx_02 = new_sfx("play_wh3_dlc20_qb_festus_altar_of_battle_intro_002");
wh3_intro_sfx_03 = new_sfx("play_wh3_dlc20_qb_festus_altar_of_battle_intro_003");
wh3_intro_sfx_04 = new_sfx("play_wh3_dlc20_qb_festus_altar_of_battle_intro_004");
wh3_intro_sfx_05 = new_sfx("play_wh3_dlc20_qb_festus_altar_of_battle_intro_005");
wh3_intro_sfx_06 = new_sfx("play_wh3_dlc20_qb_festus_altar_of_battle_intro_006");

-------------------------------------------------------------------------------------------------
------------------------------------------ WAVE VO ----------------------------------------------
-------------------------------------------------------------------------------------------------

wh3_wave_sfx_01 = new_sfx("play_wh3_dlc20_qb_festus_altar_of_battle_phase2a_001");
wh3_wave_sfx_02 = new_sfx("play_wh3_dlc20_qb_festus_altar_of_battle_phase2b_001");
wh3_wave_sfx_03 = new_sfx("play_wh3_dlc20_qb_festus_altar_of_battle_phase2c_001");		-- altar accessable line
...
wh3_reveal_sfx_04 = new_sfx("play_wh3_dlc20_qb_festus_altar_of_battle_phase3_001");
...
function play_intro_cutscene()
	...
	cutscene_intro:action(function() cam:fade(true, 0.5) end, 79900); --68s
	...
	-- Despair all ye realms, the Leechlord has come, the sad days of this world are nearing their sum! 
	cutscene_intro:add_cinematic_trigger_listener(
		"wh3_dlc20_qb_festus_altar_of_battle_intro_01", 
			function()
				cutscene_intro:play_sound(wh3_intro_sfx_01);
				bm:show_subtitle("wh3_dlc20_qb_festus_altar_of_battle_intro_01", false, true);
			end
	);

	-- Mmmm, the sweet stench of death, of souls trapped… Nurgle’s tribute still locked behind the Altar’s seal…
	cutscene_intro:add_cinematic_trigger_listener(
		"wh3_dlc20_qb_festus_altar_of_battle_intro_02", 
			function()
				cutscene_intro:play_sound(wh3_intro_sfx_02);
				bm:show_subtitle("wh3_dlc20_qb_festus_altar_of_battle_intro_02", false, true);
			end
	);

	-- But what do we have here? Marks of power to claim… power to conquer the Altar. Nurgle’s chosen shall deliver His prize!
	cutscene_intro:add_cinematic_trigger_listener(
		"wh3_dlc20_qb_festus_altar_of_battle_intro_03", 
			function()
				cutscene_intro:play_sound(wh3_intro_sfx_03);
				bm:show_subtitle("wh3_dlc20_qb_festus_altar_of_battle_intro_03", false, true);
			end
	);

	-- Well met, Children of the Changer! Do you come to meet your sickly fates early?
	cutscene_intro:add_cinematic_trigger_listener(
		"wh3_dlc20_qb_festus_altar_of_battle_intro_04", 
			function()
				cutscene_intro:play_sound(wh3_intro_sfx_04);
				bm:show_subtitle("wh3_dlc20_qb_festus_altar_of_battle_intro_04", false, true);
			end
	);

	-- The puppet master’s puppets will all soon be servants of decay, along with the rest of the world!
	cutscene_intro:add_cinematic_trigger_listener(
		"wh3_dlc20_qb_festus_altar_of_battle_intro_05", 
			function()
				cutscene_intro:play_sound(wh3_intro_sfx_05);
				bm:show_subtitle("wh3_dlc20_qb_festus_altar_of_battle_intro_05", false, true);
			end
	);

	-- O ye faithful of the Fly Lord, fill their breeches with soil, the time has come for a bit of deathly toil!
	cutscene_intro:add_cinematic_trigger_listener(
		"wh3_dlc20_qb_festus_altar_of_battle_intro_06", 
			function()
				cutscene_intro:play_sound(wh3_intro_sfx_06);
				bm:show_subtitle("wh3_dlc20_qb_festus_altar_of_battle_intro_06", false, true);
			end
	);
...
-- The Undivided are undeserving of Ruinous glory! You shall rot into nothingness, Everchosen!
...
-- Do not resist, slaves of Slaanesh! Once the world is Nurgle’s dominion, you too can be my plague-carriers.Your unsanitary ways will come in handy to spread His pestilent ruin!
...
-- Khorne sends His angry little thralls, and not just for fighting’s sake methinks.He knows! Once the Urfather’s power rises, His followers will not be spared the world’s despair!
...
-- The other Gods’ children are proven unworthy! The sickly blessings of Nurgle shall be ours!
gb:play_sound_on_message("ready_ai_wave_03", wh3_wave_sfx_03, nil, 500, nil, 500)

gb:set_objective_with_leader_on_message("1_1_deployed", "wh3_dlc20_survival_altar_of_battle_wave_azazel", 1000);
gb:complete_objective_on_message("ready_ai_wave_02", "wh3_dlc20_survival_altar_of_battle_wave_azazel", 1000);
gb:remove_objective_on_message("obj_02", "wh3_dlc20_survival_altar_of_battle_wave_azazel", 1000);

gb:set_objective_with_leader_on_message("2_1_deployed", "wh3_dlc20_survival_altar_of_battle_wave_valkia", 1000);
gb:complete_objective_on_message("ready_ai_wave_03", "wh3_dlc20_survival_altar_of_battle_wave_valkia", 1000);
gb:remove_objective_on_message("obj_03", "wh3_dlc20_survival_altar_of_battle_wave_valkia", 1000);
