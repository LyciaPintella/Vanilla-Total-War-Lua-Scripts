...
intro_cinematic_file = "script\\battle\\survival_battles\\_cutscene\\managers\\coc_altar_valkia_phase_one.CindySceneManager";
...
wh3_intro_sfx_00 = new_sfx("Play_Movie_WH3_DLC20_QB_Altar_Of_Battle_Valkia_Intro");	

wh3_intro_sfx_01 = new_sfx("play_wh3_dlc20_qb_valkia_altar_of_battle_intro_001");
wh3_intro_sfx_02 = new_sfx("play_wh3_dlc20_qb_valkia_altar_of_battle_intro_002");
wh3_intro_sfx_03 = new_sfx("play_wh3_dlc20_qb_valkia_altar_of_battle_intro_003");	-- wh3_intro_sfx_04 cut as no longer needed
wh3_intro_sfx_05 = new_sfx("play_wh3_dlc20_qb_valkia_altar_of_battle_intro_005");
wh3_intro_sfx_06 = new_sfx("play_wh3_dlc20_qb_valkia_altar_of_battle_intro_006");

wh3_intro_sfx_07 = new_sfx("Play_Movie_WH3_DLC20_QB_Altar_Of_Battle_Archaon_Reveal");	

-------------------------------------------------------------------------------------------------
------------------------------------------ WAVE VO ----------------------------------------------
-------------------------------------------------------------------------------------------------

wh3_wave_sfx_01 = new_sfx("play_wh3_dlc20_qb_valkia_altar_of_battle_phase2a_001");
wh3_wave_sfx_02 = new_sfx("play_wh3_dlc20_qb_valkia_altar_of_battle_phase2b_001");
wh3_wave_sfx_03 = new_sfx("play_wh3_dlc20_qb_valkia_altar_of_battle_phase2c_001");		-- altar accessable line
...
wh3_reveal_sfx_04 = new_sfx("play_wh3_dlc20_qb_valkia_altar_of_battle_phase3_001");
...
function play_intro_cutscene()
	...
	-- What a glorious journey of slaughter it has been! Soon we shall unleash the true savagery of Khorne upon the world!
	cutscene_intro:add_cinematic_trigger_listener(
		"wh3_dlc20_qb_valkia_altar_of_battle_intro_01", 
			function()
				cutscene_intro:play_sound(wh3_intro_sfx_01);
				bm:show_subtitle("wh3_dlc20_qb_valkia_altar_of_battle_intro_01", false, true);
			end
	);

	-- For now, the Altar’s seal endures, withholding my paramour’s tribute. How His brother-gods must gaze upon us and laugh…
	cutscene_intro:add_cinematic_trigger_listener(
		"wh3_dlc20_qb_valkia_altar_of_battle_intro_02", 
			function()
				cutscene_intro:play_sound(wh3_intro_sfx_02);
				bm:show_subtitle("wh3_dlc20_qb_valkia_altar_of_battle_intro_02", false, true);
			end
	);

	-- But let them laugh! Once we claim enough of the Altar’s Marks of Power, no challenger will stop us from taking the Bloodfather’s dues!
	cutscene_intro:add_cinematic_trigger_listener(
		"wh3_dlc20_qb_valkia_altar_of_battle_intro_03", 
			function()
				cutscene_intro:play_sound(wh3_intro_sfx_03);
				bm:show_subtitle("wh3_dlc20_qb_valkia_altar_of_battle_intro_03", false, true);
			end
	);

	-- The debauched ways of Slaanesh will be a mere sideshow to the world's Ruin. In the end, there can only be murder!
	cutscene_intro:add_cinematic_trigger_listener(
		"wh3_dlc20_qb_valkia_altar_of_battle_intro_05", 
			function()
				cutscene_intro:play_sound(wh3_intro_sfx_05);
				bm:show_subtitle("wh3_dlc20_qb_valkia_altar_of_battle_intro_05", false, true);
			end
	);

	-- They will fall before Khorne’s chosen! Clear the altar of this fodder!
	cutscene_intro:add_cinematic_trigger_listener(
		"wh3_dlc20_qb_valkia_altar_of_battle_intro_06", 
			function()
				cutscene_intro:play_sound(wh3_intro_sfx_06);
				bm:show_subtitle("wh3_dlc20_qb_valkia_altar_of_battle_intro_06", false, true);
			end
	);
...
function play_reveal_cutscene()
	...
	cutscene_reveal:action(
		function()
			...
			--ga_ai_att_04.sunits:set_invincible(true)
		end, 
		100
	);
...
-- With the Gods as my witness, I will prove you unworthy of being the Everchosen, pretender!
...
-- Tzeentch’s arduous plans are being undone, for he sends a cowardly host!The destruction of the mortal realm can only be by the reaping of blood and skulls – not conniving and conjuration!
...
-- Nurgle must want me to put his lepers out of their misery!After all, a world abound with a million hosts of Khorne will have no need for the rot-god’s influence!
...
-- The pathetic challengers are no more! Finally we will claim the Bloodfather’s tribute!
gb:play_sound_on_message("ready_ai_wave_03", wh3_wave_sfx_03, nil, 500, nil, 500)

gb:set_objective_with_leader_on_message("1_1_deployed", "wh3_dlc20_survival_altar_of_battle_wave_vilitch", 1000);
gb:complete_objective_on_message("ready_ai_wave_02", "wh3_dlc20_survival_altar_of_battle_wave_vilitch", 1000);
gb:remove_objective_on_message("obj_02", "wh3_dlc20_survival_altar_of_battle_wave_vilitch", 1000);

gb:set_objective_with_leader_on_message("2_1_deployed", "wh3_dlc20_survival_altar_of_battle_wave_festus", 1000);
gb:complete_objective_on_message("ready_ai_wave_03", "wh3_dlc20_survival_altar_of_battle_wave_festus", 1000);
gb:remove_objective_on_message("obj_03", "wh3_dlc20_survival_altar_of_battle_wave_festus", 1000);
