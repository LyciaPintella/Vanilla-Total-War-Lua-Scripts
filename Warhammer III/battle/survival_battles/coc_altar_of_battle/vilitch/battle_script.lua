...
wh3_intro_sfx_00 = new_sfx("Play_Movie_WH3_DLC20_QB_Altar_Of_Battle_Vilitch_Intro");	
...
function play_intro_cutscene()
	...
	cutscene_intro:action(function() cam:fade(true, 0.5) end, 56800); --23s
...
-- [angry growls] Yes, Thomin! More creatures for you to mangle. Khorne’s puppets are nothing against our might!
...
-- Pitiful Slaanesh. The young are always the last to know. There are no secrets here. Only the truth that the Altar is ours!
...
-- [encouraging growls] Brother, it is finally ours!
gb:play_sound_on_message("ready_ai_wave_03", wh3_wave_sfx_03, nil, 500, nil, 500)

gb:set_objective_with_leader_on_message("1_1_deployed", "wh3_dlc20_survival_altar_of_battle_wave_valkia", 1000);
gb:complete_objective_on_message("ready_ai_wave_02", "wh3_dlc20_survival_altar_of_battle_wave_valkia", 1000);
gb:remove_objective_on_message("obj_02", "wh3_dlc20_survival_altar_of_battle_wave_valkia", 1000);

gb:set_objective_with_leader_on_message("2_1_deployed", "wh3_dlc20_survival_altar_of_battle_wave_azazel", 1000);
gb:complete_objective_on_message("ready_ai_wave_03", "wh3_dlc20_survival_altar_of_battle_wave_azazel", 1000);
gb:remove_objective_on_message("obj_03", "wh3_dlc20_survival_altar_of_battle_wave_azazel", 1000);
