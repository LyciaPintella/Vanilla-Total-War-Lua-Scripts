...
intro_cinematic_file = "script\\battle\\survival_battles\\_cutscene\\managers\\tze_fortress_intro_m01.CindySceneManager";
bm:cindy_preload(intro_cinematic_file);
reveal_cinematic_file = "script\\battle\\survival_battles\\_cutscene\\managers\\tze_reveal_m01.CindySceneManager";
bm:cindy_preload(reveal_cinematic_file);
outro_cinematic_file = "script\\battle\\survival_battles\\realm_win\\managers\\realmwin_intro_tze.CindySceneManager";
bm:cindy_preload(outro_cinematic_file);

bm:force_custom_battle_result("wh3_survival_tzeentch_victory", true);
bm:force_custom_battle_result("wh3_survival_tzeentch_defeat", false);
...
local capture_point_01 = bm:capture_location_manager():capture_location_from_script_id("cp_crystal_labyrinth");
local capture_point_02 = bm:capture_location_manager():capture_location_from_script_id("cp_shifting_crystal");
local capture_point_03 = bm:capture_location_manager():capture_location_from_script_id("cp_stair_maze");
...
gb:message_on_capture_location_capture_completed("cp_1_owned", "battle_start", "cp_crystal_labyrinth", nil, ga_ai_def_01, ga_player_01);
...
gb:message_on_capture_location_capture_completed("cp_2_owned", "ready_ai_wave_02", "cp_shifting_crystal", nil, ga_ai_def_01, ga_player_01);
gb:message_on_capture_location_capture_completed("cp_2_lost", "ready_ai_wave_02", "cp_shifting_crystal", nil, ga_player_01, ga_ai_def_01);
...
gb:message_on_capture_location_capture_completed("cp_3_owned", "ready_ai_wave_03", "cp_stair_maze", nil, ga_ai_def_01, ga_player_01);
gb:message_on_capture_location_capture_completed("cp_3_lost", "ready_ai_wave_03", "cp_stair_maze", nil, ga_player_01, ga_ai_def_01);
...
wh3_intro_sfx_00 = new_sfx("WH3_Survival_Battle_Tzeentch_Sweetener_01");

wh3_intro_sfx_01 = new_sfx("play_wh3_main_camp_narrative_chs_tzeentch_battle_intro_01_1");
wh3_intro_sfx_02 = new_sfx("play_wh3_main_camp_narrative_chs_tzeentch_battle_intro_02_1");
wh3_intro_sfx_03 = new_sfx("play_wh3_main_camp_narrative_chs_tzeentch_battle_intro_03_1");
wh3_intro_sfx_04 = new_sfx("play_wh3_main_camp_narrative_chs_tzeentch_battle_intro_04_1");
wh3_intro_sfx_05 = new_sfx("play_wh3_main_camp_narrative_chs_tzeentch_battle_intro_05_1");

-------------------------------------------------------------------------------------------------
------------------------------------------ REVEAL VO --------------------------------------------
-------------------------------------------------------------------------------------------------

wh3_reveal_sfx_00 = new_sfx("WH3_Survival_Battle_Tzeentch_Sweetener_02");

wh3_reveal_sfx_01 = new_sfx("play_wh3_main_camp_narrative_chs_tzeentch_battle_intro_06_1");

-------------------------------------------------------------------------------------------------
------------------------------------------ OUTRO VO ---------------------------------------------
-------------------------------------------------------------------------------------------------

wh3_outro_sfx_00 = new_sfx("WH3_Survival_Battle_Tzeentch_Sweetener_03");
...
function play_intro_cutscene()
	...
	--cutscene_intro:action(function() cam:fade(true, 0.5) end, 49800); --55.5s
	...
	-- The Impossible Fortress… impregnable to all but the insane. 
	cutscene_intro:add_cinematic_trigger_listener(
		"wh3_main_camp_narrative_chs_tzeentch_battle_intro_01", 
			function()
				cutscene_intro:play_sound(new_sfx("play_wh3_main_camp_narrative_chs_tzeentch_battle_intro_01_1"));
				bm:show_subtitle("wh3_main_camp_narrative_chs_tzeentch_battle_intro_01", false, true);
			end
	);

	-- Too enter the fastness unbidden would be a mistake, but it is enough to pierce its outer-defences to summon the wrath of the Librarian.
	cutscene_intro:add_cinematic_trigger_listener(
		"wh3_main_camp_narrative_chs_tzeentch_battle_intro_02", 
			function()
				cutscene_intro:play_sound(new_sfx("play_wh3_main_camp_narrative_chs_tzeentch_battle_intro_02_1"));
				bm:show_subtitle("wh3_main_camp_narrative_chs_tzeentch_battle_intro_02", false, true);
			end
	);

	-- Control the Crystal of Lore in the labyrinth. This will give you a foothold and grant us supplies to reinforce for the struggle ahead.   
	cutscene_intro:add_cinematic_trigger_listener(
		"wh3_main_camp_narrative_chs_tzeentch_battle_intro_03", 
			function()
				cutscene_intro:play_sound(new_sfx("play_wh3_main_camp_narrative_chs_tzeentch_battle_intro_03_1"));
				bm:show_subtitle("wh3_main_camp_narrative_chs_tzeentch_battle_intro_03", false, true);
			end
	);

	-- There are two other crystals you will need to capture and so dominate the battle. 
	cutscene_intro:add_cinematic_trigger_listener(
		"wh3_main_camp_narrative_chs_tzeentch_battle_intro_04", 
			function()
				cutscene_intro:play_sound(new_sfx("play_wh3_main_camp_narrative_chs_tzeentch_battle_intro_04_1"));
				bm:show_subtitle("wh3_main_camp_narrative_chs_tzeentch_battle_intro_04", false, true);
			end
	);

	-- Confound the Greater Changer! Refuse to play the role He has cast you in, and destroy all who get in your way!
	cutscene_intro:add_cinematic_trigger_listener(
		"wh3_main_camp_narrative_chs_tzeentch_battle_intro_05", 
			function()
				cutscene_intro:play_sound(new_sfx("play_wh3_main_camp_narrative_chs_tzeentch_battle_intro_05_1"));
				bm:show_subtitle("wh3_main_camp_narrative_chs_tzeentch_battle_intro_05", false, true);
			end
	);

	cutscene_intro:set_music("Tzeentch_Intro", 0, 0)
...
function play_reveal_cutscene()
	...
	-- set up fade actions on cutscene
	cutscene_reveal:action(function() cam:fade(true, 0.5) end, 19300); --20.8s
	...
	-- The Librarian is summoned! Execute Tzeentch's favoured Daemon Prince and steal his soul!
	cutscene_reveal:add_cinematic_trigger_listener(
		"wh3_main_camp_narrative_chs_tzeentch_battle_intro_06", 
			function()
				cutscene_reveal:play_sound(new_sfx("play_wh3_main_camp_narrative_chs_tzeentch_battle_intro_06_1"));
				bm:show_subtitle("wh3_main_camp_narrative_chs_tzeentch_battle_intro_06", false, true);
			end
	);

	cutscene_reveal:set_music("Tzeentch_Daemon_Prince", 0, 0)
...
function play_outro_cutscene()
	...
	cutscene_outro:set_music("Tzeentch_Realm_Conquered", 0, 0)
...
function teleport_def_01_units()
	...
	ga_ai_def_01.sunits:item(1).uc:teleport_to_location(v(74.30, -389.05), 160.0, 22.0);
	ga_ai_def_01.sunits:item(2).uc:teleport_to_location(v(52.14, -400.19), 160.0, 22.0);
	ga_ai_def_01.sunits:item(3).uc:teleport_to_location(v(29.98, -411.32), 160.0, 22.0);
	ga_ai_def_01.sunits:item(4).uc:teleport_to_location(v(7.82, -422.46), 160.0, 22.0);
	ga_ai_def_01.sunits:item(5).uc:teleport_to_location(v(10.23, -395.63), 160.0, 31.0);
	ga_ai_def_01.sunits:item(6).uc:teleport_to_location(v(46.88, -377.24), 160.0, 31.0);
end;
...
function teleport_def_02_units()
	...
	ga_ai_def_02.sunits:item(1).uc:teleport_to_location(v(-152.66, -116.26), 180.0, 21.70); 
	ga_ai_def_02.sunits:item(2).uc:teleport_to_location(v(-176.29, -114.40), 180.0, 21.70); 
	ga_ai_def_02.sunits:item(3).uc:teleport_to_location(v(-199.92, -112.54), 180.0, 21.70); 
	ga_ai_def_02.sunits:item(4).uc:teleport_to_location(v(-223.54, -110.68), 180.0, 21.70); 

	ga_ai_def_02.sunits:item(5).uc:teleport_to_location(v(-214.22, -77.88), 180.0, 38.00);
	ga_ai_def_02.sunits:item(6).uc:teleport_to_location(v(-166.28, -80.25), 180.0, 38.00);
end;
...
function teleport_def_03_units()
	...
	ga_ai_def_03.sunits:item(1).uc:teleport_to_location(v(-7.74, 361.53), 180.0, 21.70);
	ga_ai_def_03.sunits:item(2).uc:teleport_to_location(v(-29.52, 370.87), 180.0, 21.70);
	ga_ai_def_03.sunits:item(3).uc:teleport_to_location(v(-51.31, 380.20), 180.0, 21.70);
	ga_ai_def_03.sunits:item(4).uc:teleport_to_location(v(-73.09, 389.54), 180.0, 21.70);

	ga_ai_def_03.sunits:item(5).uc:teleport_to_location(v(31.55, 400.46), 180.0, 38.00); 
	ga_ai_def_03.sunits:item(6).uc:teleport_to_location(v(-68.68, 441.85), 180.0, 38.00); 

	ga_ai_def_03.sunits:item(7).uc:teleport_to_location(v(-26.12, 407.36), 180.0, 3.20); 
end;
...
function teleport_boss()
	...
	ga_ai_att_04.sunits:item(1).uc:teleport_to_location(v(-30.0, 500.0), 180.0, 4.5);
...
-------DEFENDER 1-------
ga_ai_def_01:defend_on_message("battle_start" , 90, -445, 50);
...
ga_ai_def_02:defend_on_message("ready_ai_wave_02" , -175, -80, 50);
...
ga_ai_def_03:defend_on_message("ready_ai_wave_03" , -45, 390, 50);
...
gb:add_listener(
	...
	function()
		bm:set_locatable_objective(
			"wh3_survival_point_tze_crystals", 
...
gb:complete_objective_on_message("cp_1_owned", "wh3_survival_point_tze_crystals", 1000);
gb:remove_objective_on_message("1_1_deployed", "wh3_survival_point_tze_crystals", 1000);

gb:add_listener(
	"obj_02",
	function()
		bm:set_locatable_objective(
			"wh3_survival_point_tze_labyrinth", 
			v(-127.25, 116.19, -186.34), 
			v(-115.20, 5.37, 63.73), 
			1, 
			true
		);
...
gb:complete_objective_on_message("cp_2_owned", "wh3_survival_point_tze_labyrinth", 1000);
gb:remove_objective_on_message("2_1_deployed", "wh3_survival_point_tze_labyrinth", 1000);

gb:add_listener(
	"obj_03",
	function()
		bm:set_locatable_objective(
			"wh3_survival_point_tze_maze", 
			v(-65.77, 168.73, 242.50), 
			v(-23.25, 126.84, 509.66), 
			1, 
			true
		);
	end
);
gb:complete_objective_on_message("cp_3_owned", "wh3_survival_point_tze_maze", 1000);
gb:remove_objective_on_message("3_1_deployed", "wh3_survival_point_tze_maze", 1000);

gb:set_objective_with_leader_on_message("reveal_cutscene_end", "wh3_survival_boss_tzeentch", 1000);
gb:complete_objective_on_message("prepare_for_outro", "wh3_survival_boss_tzeentch", 1000);
...
gb:set_objective_with_leader_on_message("1_1_deployed", "wh3_survival_wave_tzeentch", 1000);
gb:complete_objective_on_message("ready_ai_wave_02", "wh3_survival_wave_tzeentch", 1000);
gb:remove_objective_on_message("obj_02", "wh3_survival_wave_tzeentch", 1000);

gb:set_objective_with_leader_on_message("2_1_deployed", "wh3_survival_wave_tzeentch", 1000);
gb:complete_objective_on_message("ready_ai_wave_03", "wh3_survival_wave_tzeentch", 1000);
gb:remove_objective_on_message("obj_03", "wh3_survival_wave_tzeentch", 1000);

gb:add_listener(
	"4_deployed",
	function()
		if ga_ai_att_04.sunits:are_any_active_on_battlefield() == true then
			bm:set_objective_with_leader("wh3_survival_boss_tzeentch");
		end;
	end,
	true
);
...
loading_screen_key_defeat = "wh3_main_survival_impossible_fortress_defeat";
...
if num_realms_completed == 0 then
	loading_screen_win = "wh3_main_survival_impossible_fortress_first_win";
elseif num_realms_completed == 1 then
	loading_screen_win = "wh3_main_survival_impossible_fortress_second_win";
elseif num_realms_completed == 2 then
	loading_screen_win = "wh3_main_survival_impossible_fortress_third_win";
elseif num_realms_completed == 3 then
	loading_screen_win = "wh3_main_survival_impossible_fortress_fourth_win";
end
