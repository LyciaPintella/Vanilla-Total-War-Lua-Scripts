...
function play_cutscene_deployment()
	...
	second_battle_start_cutscene_deployment(
		v(-421.4, 2169.8, 459.8), 							-- end camera position
		v(-316.2, 2134.3, 360.2), 							-- end camera target
...
function play_battle_attacker_advice()
	...
	second_battle_start_cutscene_attacker(
		v(-78.5, 2157.8, -45.6), 							-- start camera pos
		v(-39.8, 2138.6, 97.3),								-- start camera targ
		v(99.0, 2157.8, -28.1), 							-- end camera pos
		v(28.6, 2128.8, 100.3),								-- end camera targ
		45,													-- cutscene fov
		sunits_player_all,									-- sunits collection of all players army
...
function monitor_for_player_deployment_in_forest()
	...
	second_battle_monitor_for_player_deployment_in_forest(
		...
		v(90, 80, 40),																		-- position offset for completion camera
...
function play_cutscene_hill_deployment()
	...
	second_battle_start_hill_deployment(
		v(-12.9, 2162.1, 2.6),										-- cutscene start cam
		v(-149.1, 2131.0, 54.9), 									-- cutscene start targ
		v(-25.3, 2166.8, 256.2), 									-- cutscene end cam
		v(-65.0, 2129.9, 117.2), 									-- cutscene end targ
		...
		v(-140, 2138, 156),											-- marker position
		"wh2.battle.intro.hill_deployment.001",						-- objective key
		v(-10, 15, 80),												-- end camera position offset
