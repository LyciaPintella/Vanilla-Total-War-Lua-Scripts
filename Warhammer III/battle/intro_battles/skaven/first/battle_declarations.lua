...
local pos_intro_start_dest = v(-467, -288.0);

sunit_player_02.pos_intro_start = v(-512.7, -284.3);
...
do 
	...
	if sunit_player_03_initial_men < 62 then
		-- small/medium unit size
		sunit_player_03.pos_intro_start = v(-527.7, -284.4);		
		sunit_player_04.pos_intro_start = v(-542.7, -283.1);
		
	else
		-- large/ultra unit size
		sunit_player_03.pos_intro_start = v(-539.3, -283.7);
		sunit_player_04.pos_intro_start = v(-566.4, -283.1);
	end;
...
sunit_player_01.pos_intro_mid = v(-219.0, -162.1);
