...
function play_cutscene_deployment()
	...
	second_battle_start_cutscene_deployment(
		v(481.7, 626.0, 448.0), 							-- end camera position
		v(352.4, 562.7, 336.6), 							-- end camera target
...
function play_battle_attacker_advice()
	...
	second_battle_start_cutscene_attacker(
		v(-55.1, 590.4, 49.1), 								-- start camera pos
		v(117.5, 559.4, 47.1),								-- start camera targ
		v(-51.3, 590.4, -89.5),								-- end camera pos
		v(110.6, 558.3, -31.7),								-- end camera targ
		45,													-- cutscene fov
		sunits_player_all,									-- sunits collection of all players army
...
function play_cutscene_hill_deployment()
	...
	second_battle_start_hill_deployment(
		v(-25.3, 611.0, 14.8),										-- cutscene start cam
		v(66.7, 563.2, 156.3), 										-- cutscene start targ
		v(310.4, 620.7, 51.7), 										-- cutscene end cam
		v(144.0, 567.3, 67.1), 										-- cutscene end targ
		...
		v(150, 580, 150),											-- marker position
		"wh2.battle.intro.hill_deployment.001",						-- objective key
		v(100, 30, 10),												-- end camera position offset
