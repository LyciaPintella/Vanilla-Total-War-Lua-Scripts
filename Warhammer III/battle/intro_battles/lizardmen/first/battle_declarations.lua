...
local pos_intro_start_dest = v(-455.0, -287.0);

sunit_player_02.pos_intro_start = v(-492.65, -284.3);
sunit_player_02.orient_intro_start = r_to_d(1.59);
sunit_player_02.width_intro_start = 15.8;
sunit_player_02.pos_intro_start_dest = v(-400.0, -309.0);

sunit_player_03.pos_intro_start = v(-531.0, -283.7);
sunit_player_03.orient_intro_start = r_to_d(1.59);
sunit_player_03.width_intro_start = 16.4;
sunit_player_03.pos_intro_start_dest = v(-435.0, -296.0);

sunit_player_04.pos_intro_start = v(-570.4, -282.3);
sunit_player_04.orient_intro_start = r_to_d(1.56);
sunit_player_04.width_intro_start = 16.1;
sunit_player_04.pos_intro_start_dest = v(-455.0, -287.0);
...
sunit_enemy_02.pos_meander_start = v(230.9, -229.2);
sunit_enemy_02.orient_meander =  r_to_d(-1.74);
sunit_enemy_02.width_meander = 22.9;

sunit_enemy_03.pos_meander_start = v(235.1, -253.8);
sunit_enemy_03.orient_meander = r_to_d(-1.74);
sunit_enemy_03.width_meander = 22.9;

sunit_enemy_04.pos_meander_start = v(239.3, -278.4);
sunit_enemy_04.orient_meander = r_to_d(-1.74);
sunit_enemy_04.width_meander = 22.9;
