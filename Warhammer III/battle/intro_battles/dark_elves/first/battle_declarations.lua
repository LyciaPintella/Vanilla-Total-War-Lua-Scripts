...
local pos_intro_start_dest = v(-352.4, -250.8);

sunit_player_02.pos_intro_start = v(-412.0, -249.6);
sunit_player_02.orient_intro_start = r_to_d(1.63);
sunit_player_02.width_intro_start = 11.5;
...
do
	...
	if sunit_player_03_initial_men < 32 then
		-- small unit size
		sunit_player_03.pos_intro_start = v(-427.0, -247.9);
		sunit_player_04.pos_intro_start = v(-442.0, -247.9);
		
	elseif sunit_player_03_initial_men < 62 then
		-- medium unit size
		sunit_player_03.pos_intro_start = v(-432.0, -247.9);
		sunit_player_04.pos_intro_start = v(-452.0, -247.9);
		
	elseif sunit_player_03_initial_men < 92 then
		-- large unit size
		sunit_player_03.pos_intro_start = v(-434.8, -247.9);
		sunit_player_04.pos_intro_start = v(-457.3, -247.9);
		
	else
		-- ultra unit size
		sunit_player_03.pos_intro_start = v(-442.0, -247.9);
		sunit_player_04.pos_intro_start = v(-472.0, -247.9);
	end;

	sunit_player_03.orient_intro_start = r_to_d(1.61);
	sunit_player_03.width_intro_start = 11.5;
	sunit_player_03.pos_intro_start_dest = pos_intro_start_dest;

	sunit_player_04.orient_intro_start = r_to_d(1.63);
	sunit_player_04.width_intro_start = 11.5;
...
sunit_player_01.pos_intro_mid = v(-217.3, -157.4);
sunit_player_01.orient_intro_mid = r_to_d(1.57);
...
sunit_enemy_20 = script_unit:new_by_reference(army_enemy_02, "enemy_20");
...
sunit_enemy_01.pos_meander_start = v(217.0, -206);
sunit_enemy_01.pos_meander_end = v(222, -266);
sunit_enemy_01.orient_meander = r_to_d(-1.75);
sunit_enemy_01.width_meander = 1.4;

sunit_enemy_02.pos_meander_start = v(224.8, -214.4);
sunit_enemy_02.orient_meander =  r_to_d(-1.67);
sunit_enemy_02.width_meander = 19.06;

sunit_enemy_03.pos_meander_start = v(226.9, -235.3);
sunit_enemy_03.orient_meander = r_to_d(-1.67);
sunit_enemy_03.width_meander = 19.06;

sunit_enemy_04.pos_meander_start = v(229.0, -257.0);
sunit_enemy_04.orient_meander = r_to_d(-1.67);
sunit_enemy_04.width_meander = 20.5;


-- starting enemy formup positions
sunit_enemy_01.pos_form_up = v(183.0, -201.6);
sunit_enemy_01.orient_form_up = r_to_d(-1.73);
sunit_enemy_01.width_form_up = 1.4;

sunit_enemy_02.pos_form_up = v(184.9, -213.7);
sunit_enemy_02.orient_form_up =  r_to_d(-1.73);
sunit_enemy_02.width_form_up = 19.1;

sunit_enemy_03.pos_form_up = v(188.3, -234.4);
sunit_enemy_03.orient_form_up = r_to_d(-1.73);
sunit_enemy_03.width_form_up = 19.1;

sunit_enemy_04.pos_form_up = v(191.8, -255.9);
sunit_enemy_04.orient_form_up = r_to_d(-1.73);
sunit_enemy_04.width_form_up = 20.5;
...
enemy_reinforcements_teleport_z_offset = 100;
