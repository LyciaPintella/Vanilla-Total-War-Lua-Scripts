...
intro_cinematic_file = "script/battle/quest_battles/_cutscene/managers/ubu_katarin.CindySceneManager";
bm:cindy_preload(intro_cinematic_file);
-------------------------------------------------------------------------------------------------
---------------------------------------- INTRO VO & SUBS ----------------------------------------
-------------------------------------------------------------------------------------------------
wh3_main_sfx_01 = new_sfx("play_wh3_main_qb_ksl_katarin_the_frozen_falls_01");
wh3_main_sfx_02 = new_sfx("play_wh3_main_qb_ksl_katarin_the_frozen_falls_02");
...
function end_deployment_phase()
	...
	local cutscene_intro = cutscene:new_from_cindyscene(
		...
		"script/battle/quest_battles/_cutscene/managers/ubu_katarin.CindySceneManager",			-- path to cindyscene
		0,																						-- blend in time (s)
		2																						-- blend out time (s)
	);
	...
	-- My father! Already ensnared by Chaos magicks. Sons and daughters of Kislev, we will not let these foul puppets deprive us of Kislev's sire once more.
	cutscene_intro:add_cinematic_trigger_listener(
		"wh3_main_qb_ksl_katarin_the_frozen_falls_01", 
			function()
				cutscene_intro:play_sound(new_sfx("play_wh3_main_qb_ksl_katarin_the_frozen_falls_01"));
				bm:show_subtitle("wh3_main_qb_ksl_katarin_the_frozen_falls_01", false, true);
			end
	)

	-- Steel your hearts – we fight to free the Red Tzar!
	cutscene_intro:add_cinematic_trigger_listener(
		"wh3_main_qb_ksl_katarin_the_frozen_falls_02", 
			function()
				cutscene_intro:play_sound(new_sfx("play_wh3_main_qb_ksl_katarin_the_frozen_falls_02"));
				bm:show_subtitle("wh3_main_qb_ksl_katarin_the_frozen_falls_02", false, true);
			end
	)
