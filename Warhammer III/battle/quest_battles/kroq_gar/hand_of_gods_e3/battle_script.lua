...
ga_lizardmen_01 = gb:get_army(gb:get_player_alliance_num(), 1,"feral_bastiladon");
ga_lizardmen_02 = gb:get_army(gb:get_player_alliance_num(), 1,"player_army_projectile");
ga_lizardmen_03 = gb:get_army(gb:get_player_alliance_num(), 1,"player_army_infantry");
ga_lizardmen_04 = gb:get_army(gb:get_player_alliance_num(), 1,"terrible_dons");
...
function end_deployment_phase()
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_main_great_vortex_liz_kroq_gar_hand_of_gods_stage_3_pt_01", "subtitle_with_frame", 2)	end, 20300);	
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_main_great_vortex_liz_kroq_gar_hand_of_gods_stage_3_pt_02", "subtitle_with_frame", 3)	end, 23500);	
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_main_great_vortex_liz_kroq_gar_hand_of_gods_stage_3_pt_03", "subtitle_with_frame", 4.5)	end, 36500);	
	cutscene_intro:action(function() cutscene_intro:hide_custom_cutscene_subtitles() end, 43000);
	
	--cutscene_intro:action(function() cutscene_intro:play_sound(wh2_main_sfx_04) end, 40000);
	--cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_main_great_vortex_liz_kroq_gar_hand_of_gods_stage_3_pt_04", "subtitle_with_frame", 5)	end, 40500);	
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_main_great_vortex_liz_kroq_gar_hand_of_gods_stage_3_pt_05", "subtitle_with_frame", 5.5)	end, 55200);
...
-------------------------------------------------------------------------------------------------
	...
	--generated_battle:queue_help_on_message(message, objective_key, display_time, fade_time, offset_time, is_high_priority)

--- BATTLE STARTED
	ga_high_elves_03:release_on_message("battle_started"); 
	ga_lizardmen_01:goto_location_offset_on_message("battle_started", 0, 90, false);
...
--- REINFORCING DRAGON
	ga_high_elves_03:message_on_casualties("04_reinforcing_dragon", 0.5);		
	ga_high_elves_06:reinforce_on_message("04_reinforcing_dragon", 1000);
	ga_high_elves_06:attack_on_message("04_reinforcing_dragon", 2000);
	gb:queue_help_on_message("04_reinforcing_dragon", "wh2_main_qb_lzd_kroqgar_hand_of_gods_stage_3_fallen_gates_hint_dragon", 10000, 500, 2000, "04_reinforcing_dragon_vo");
	gb:play_sound_on_message("04_reinforcing_dragon_vo", wh2_main_sfx_04_reinforcing_dragon, v(0,0), nil, nil, 5000);
	gb:start_terrain_composite_scene_on_message("04_reinforcing_dragon", beam_stage_2, 2000)	
...
--- REINFORCING TERRADONS
	ga_lizardmen_04:reinforce_on_message("07_guard_release_all_armies", 10000);
...
--- REINFORCING MAGES
	ga_high_elves_01:message_on_proximity_to_enemy("08_reinforcing_mages", 5);
	ga_high_elves_05:reinforce_on_message("08_reinforcing_mages", 10000);
	gb:queue_help_on_message("08_reinforcing_mages", "wh2_main_qb_lzd_kroqgar_hand_of_gods_stage_3_fallen_gates_hint_reinforcements", 10000, 500, 10000, nil, "08_reinforcing_mages_vo");
	...
	gb:stop_terrain_composite_scene_on_message("08_reinforcing_mages", beam_stage_1, 500);
	gb:stop_terrain_composite_scene_on_message("08_reinforcing_mages", beam_stage_2, 500);
	gb:stop_terrain_composite_scene_on_message("08_reinforcing_mages", beam_stage_3, 500);	
