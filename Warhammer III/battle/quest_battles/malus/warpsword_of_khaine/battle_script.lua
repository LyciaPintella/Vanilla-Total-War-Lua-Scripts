...
function end_deployment_phase()
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc14_emp_Malus_Darkblade_Warpsword_of_Khaine_pt_01", "subtitle_with_frame", 0.1, true) end, 2000);	
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc14_emp_Malus_Darkblade_Warpsword_of_Khaine_pt_02", "subtitle_with_frame", 0.1, true) end, 16000);	
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc14_emp_Malus_Darkblade_Warpsword_of_Khaine_pt_03", "subtitle_with_frame", 0.1, true) end, 37000);	
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc14_emp_Malus_Darkblade_Warpsword_of_Khaine_pt_04", "subtitle_with_frame", 0.1, true) end, 47500);	
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc14_emp_Malus_Darkblade_Warpsword_of_Khaine_pt_05", "subtitle_with_frame", 0.1, true) end, 63500);	
