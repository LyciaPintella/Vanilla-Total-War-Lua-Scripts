...
wh2_main_sfx_02 = new_sfx("Play_wh2_dlc12_lzd_lordkroak_qb_pt_02_tiktaqto");
...
function end_deployment_phase()
	...
	cutscene_intro:action(function() cutscene_intro:play_sound(wh2_main_sfx_02); bm:queue_advisor("wh2.dlc12.lzd.lordkroak.qb.pt.02.tiktaqto"); end, 11000);	
