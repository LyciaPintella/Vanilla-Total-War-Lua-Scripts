...
function end_deployment_phase()
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_main_qb_def_malekith_destroyer_stage_3_vauls_anvil_pt_01", "subtitle_with_frame", 0.1) end, 3100);	
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_main_qb_def_malekith_destroyer_stage_3_vauls_anvil_pt_02", "subtitle_with_frame", 0.1) end, 11600);	
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_main_qb_def_malekith_destroyer_stage_3_vauls_anvil_pt_03", "subtitle_with_frame", 0.1) end, 17100);	
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_main_qb_def_malekith_destroyer_stage_3_vauls_anvil_pt_04", "subtitle_with_frame", 0.1) end, 22000);	
