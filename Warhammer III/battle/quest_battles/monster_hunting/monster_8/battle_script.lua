...
gb = generated_battle:new(
                ...
                function() 
                                                                ...
                                                                bm:callback(function() bm:out("triggering wh2_dlc10.battle.speech.nor.battle_phoenix.001"); bm:queue_advisor("wh2_dlc10.battle.speech.nor.battle_phoenix.001") end, 2000); 
				end,       -- intro cutscene function
                false                                                  -- debug mode
);

--generated_cutscene:add_element(sfx_name, subtitle, camera, min_length, wait_for_vo, wait_for_camera, loop_camera)
gc:add_element(nil, nil, "gc_medium_absolute_dlc10_phoenix_00", 18000, true, false, false);
...
-------OBJECTIVES-------
gb:queue_help_on_message("battle_started", "wh_dlc08_qb_monster_hunt_8_hint_objective");
gb:queue_help_on_message("hint_revival", "wh_dlc08_qb_monster_hunt_8_hint_boss_ability");
gb:queue_help_on_message("hurt", "wh_dlc08_qb_monster_hunt_8_hint_boss_gone");
gb:set_objective_on_message("deployment_started", "wh_dlc08_qb_monster_hunt_objective");
gb:set_objective_on_message("deployment_started", "wh_dlc08_qb_monster_hunt_objective_8_0");
gb:set_objective_on_message("deployment_started", "wh_dlc08_qb_monster_hunt_objective_8_1");
...
ga_ai_03:reinforce_on_message("release_boss",15000);
