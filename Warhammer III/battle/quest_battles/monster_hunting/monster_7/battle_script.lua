...
gb = generated_battle:new(
                ...
                function() 
                                                                ...
                                                                bm:callback(function() bm:out("triggering dlc08.battle.speech.nor.battle_terrorgheist.001"); bm:queue_advisor("dlc08.battle.speech.nor.battle_terrorgheist.001") end, 2000); 
																bm:callback(function() bm:out("triggering dlc08.battle.speech.nor.battle_terrorgheist.002"); bm:queue_advisor("dlc08.battle.speech.nor.battle_terrorgheist.002") end, 12200);
...
gc:add_element(nil, nil, "gc_medium_absolute_leitzeger_shrine_01_to_absolute_leitzeger_shrine_02", 4000, true, false, false);
gc:add_element(nil, nil, nil, 4000, true, false, false);
...
-------OBJECTIVES-------
gb:queue_help_on_message("battle_started", "wh_dlc08_qb_monster_hunt_7_hint_objective");
gb:queue_help_on_message("hint_revival", "wh_dlc08_qb_monster_hunt_7_hint_boss_ability");
gb:queue_help_on_message("hurt", "wh_dlc08_qb_monster_hunt_7_hint_boss_gone");
gb:set_objective_on_message("deployment_started", "wh_dlc08_qb_monster_hunt_objective");
gb:set_objective_on_message("deployment_started", "wh_dlc08_qb_monster_hunt_objective_7_0");
