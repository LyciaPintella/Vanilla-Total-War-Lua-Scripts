...
wh2_main_sfx_01 = new_sfx("Play_wh2_dlc09_tmb_khalida_qb_final_battle_01");
wh2_main_sfx_02 = new_sfx("Play_wh2_dlc09_tmb_khalida_qb_final_battle_02");
wh2_main_sfx_03 = new_sfx("Play_wh2_dlc09_tmb_khalida_qb_final_battle_03");
...
function end_deployment_phase()
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc09_tmb_khalida_qb_final_battle_01", "subtitle_with_frame", 0.1)	end, 3000);	
	cutscene_intro:action(function() cutscene_intro:hide_custom_cutscene_subtitles() end, 11400);
	
	cutscene_intro:action(function() cutscene_intro:play_sound(wh2_main_sfx_02) end, 11500);	
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc09_tmb_khalida_qb_final_battle_02", "subtitle_with_frame", 0.1)	end, 11500);	
	cutscene_intro:action(function() cutscene_intro:hide_custom_cutscene_subtitles() end, 23500);
	
	cutscene_intro:action(function() cutscene_intro:play_sound(wh2_main_sfx_03) end, 23600);	
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc09_tmb_khalida_qb_final_battle_03", "subtitle_with_frame", 0.1)	end, 23600);	
	cutscene_intro:action(function() cutscene_intro:hide_custom_cutscene_subtitles() end, 31400);
