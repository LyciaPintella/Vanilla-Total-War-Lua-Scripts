...
function end_deployment_phase()
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc14_Repanse_de_Lyonese_final_battle_guardian_pt_01", "subtitle_with_frame", 0.1, true) end, 2000);	
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc14_Repanse_de_Lyonese_final_battle_guardian_pt_02", "subtitle_with_frame", 0.1, true) end, 15500);	
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc14_Repanse_de_Lyonese_final_battle_pt_03", "subtitle_with_frame", 0.1, true) end, 29500);	
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc14_Repanse_de_Lyonese_final_battle_pt_04", "subtitle_with_frame", 0.1, true) end, 39000);	
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc14_Repanse_de_Lyonese_final_battle_pt_05", "subtitle_with_frame", 0.1, true) end, 48500);	
