...
-- Cylostra Direfin
-- The Bordeleux Flabellum - Bretonnia
-- Shifting Isles
-- Defender
...
intro_cinematic_file = "script\\battle\\quest_battles\\_cutscene\\managers\\cba.CindySceneManager";
bm:cindy_preload(intro_cinematic_file);
-------------------------------------------------------------------------------------------------
---------------------------------------- INTRO VO & SUBS ----------------------------------------
-------------------------------------------------------------------------------------------------
wh2_main_sfx_01 = new_sfx("Play_wh2_dlc11_cylosta_direfin_qb_bordeleaux_flabellum_pt_01");
wh2_main_sfx_02 = new_sfx("Play_wh2_dlc11_cylosta_direfin_qb_bordeleaux_flabellum_pt_02");
...
bm:out("\tend_deployment_phase() called");
	...
	cutscene_intro:action(function() bm:cindy_playback("script\\battle\\quest_battles\\_cutscene\\managers\\cba.CindySceneManager", true) end, 200);
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc11_CylostaDirefin_QB_Bordeleaux_Flabellum_pt_01", "subtitle_with_frame", 9) end, 3500);	
	...
	cutscene_intro:action(function() cutscene_intro:show_custom_cutscene_subtitle("scripted_subtitles_localised_text_wh2_dlc11_CylostaDirefin_QB_Bordeleaux_Flabellum_pt_02", "subtitle_with_frame", 9) end, 14000);	
...
------------------------------------------- OBJECTIVES ------------------------------------------
-------------------------------------------------------------------------------------------------
objective = "wh2_dlc11_qb_cylostra_battle_main_objective_bretonnia";
...
--------------------------------------------- HINTS ---------------------------------------------
-------------------------------------------------------------------------------------------------
gb:queue_help_on_message("01_intro_cutscene_end", "wh2_dlc11_qb_cylostra_battle_hint_objective_bretonnia", 6000, nil, 5000);
gb:queue_help_on_message("reinforcements", "wh2_dlc11_qb_cylostra_battle_hint_reinforcement_bretonnia", 10000, nil, 5000);
