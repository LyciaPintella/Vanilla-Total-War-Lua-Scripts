...
--Player + Allies
	...
	cutscene_morghur_dead:action(
		function()
			ga_reinforcement_army_prisoners_01.sunits:item(1).uc:teleport_to_location(v(-472, 356), 100, 18);
			ga_reinforcement_army_prisoners_01.sunits:item(2).uc:teleport_to_location(v(-472, 374), 100, 18);
			ga_reinforcement_army_prisoners_01.sunits:item(3).uc:teleport_to_location(v(-472, 392), 100, 18);
			ga_reinforcement_army_prisoners_01.sunits:item(4).uc:teleport_to_location(v(-454, 347), 100, 18);
			ga_reinforcement_army_prisoners_01.sunits:item(5).uc:teleport_to_location(v(-454, 365), 100, 18);
			ga_reinforcement_army_prisoners_01.sunits:item(6).uc:teleport_to_location(v(-454, 383), 100, 18);
			ga_reinforcement_army_prisoners_01.sunits:item(7).uc:teleport_to_location(v(-454, 401), 100, 18);
			ga_reinforcement_army_prisoners_01.sunits:item(8).uc:teleport_to_location(v(-463, 356), 100, 18);
			ga_reinforcement_army_prisoners_01.sunits:item(9).uc:teleport_to_location(v(-463, 374), 100, 18);
			ga_reinforcement_army_prisoners_01.sunits:item(10).uc:teleport_to_location(v(-463, 392), 100, 18);
		end,
		26500
	);
	cutscene_morghur_dead:action(
		function()
			--Zoom to Prisoners 2
			cam:fade(false, 0.5);
			cam:move_to(v(-448.213959,87.18969,374.05603),v(-449.210236,87.245125,373.992737), 0, false, 60);
