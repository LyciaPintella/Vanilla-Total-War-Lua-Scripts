...
if cm:is_new_game() then
	local faction_key = "wh3_main_ogr_disciples_of_the_maw";
	...
	local cindy_scene_key = "ogr_skrag";

	local advice_to_play = {
		"wh3_main_camp_chaos_ogr_disciples_of_the_maw_intro_01",
		"wh3_main_camp_chaos_ogr_disciples_of_the_maw_intro_02",
		"wh3_main_camp_chaos_ogr_disciples_of_the_maw_intro_03",
		"wh3_main_camp_chaos_ogr_disciples_of_the_maw_intro_04",
		"wh3_main_camp_chaos_ogr_disciples_of_the_maw_intro_05",
		"wh3_main_camp_chaos_ogr_disciples_of_the_maw_intro_06"
	};
	...
	local function pre_cindyscene_delay_callback(progression_callback)
		show_intro_story_panel_with_progression_callback(faction_key, "wh3_main_story_panel_intro_ogr", progression_callback);
	end;
