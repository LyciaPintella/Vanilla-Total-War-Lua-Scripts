...
if cm:is_new_game() then
	local faction_key = "wh3_main_kho_exiles_of_khorne";
	...
	local function pre_cindyscene_delay_callback(progression_callback)
		show_intro_story_panel_with_progression_callback(faction_key, "wh3_main_story_panel_intro_kho", progression_callback);
	end;
