...
if cm:is_new_game() then
	local faction_key = "wh3_main_nur_poxmakers_of_nurgle";
	...
	local cindy_scene_key = "ngl_kugath";

	local advice_to_play = {
		"wh3_main_camp_chaos_nur_poxmakers_nurgle_intro_01",
		"wh3_main_camp_chaos_nur_poxmakers_nurgle_intro_02",
		"wh3_main_camp_chaos_nur_poxmakers_nurgle_intro_03",
		"wh3_main_camp_chaos_nur_poxmakers_nurgle_intro_04",
		"wh3_main_camp_chaos_nur_poxmakers_nurgle_intro_05",
		"wh3_main_camp_chaos_nur_poxmakers_nurgle_intro_06",
		"wh3_main_camp_chaos_nur_poxmakers_nurgle_intro_07"
	};
	...
	local fullscreen_movie = "warhammer3/nur/nur_intro_plg";
	...
	local hide_faction_leader_during_cutscene = 70;
	...
	local function pre_cindyscene_delay_callback(progression_callback)
		show_intro_story_panel_with_progression_callback(faction_key, "wh3_main_story_panel_intro_nur", progression_callback);
	end;
